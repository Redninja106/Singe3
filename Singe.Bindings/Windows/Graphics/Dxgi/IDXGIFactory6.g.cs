...
namespace Windows.Win32
{
    ...
    namespace Graphics.Dxgi
    {
        ...
        internal unsafe struct IDXGIFactory6
        {
            ...
            {
                fixed (IDXGIFactory6*pThis = &this)
            ...
            /// <inheritdoc cref = "EnumAdapterByGpuPreference(uint, win32.Graphics.Dxgi.DXGI_GPU_PREFERENCE, global::System.Guid*, void **)"/>
            internal unsafe win32.System.Com.HRESULT EnumAdapterByGpuPreference(uint Adapter, win32.Graphics.Dxgi.DXGI_GPU_PREFERENCE GpuPreference, in global::System.Guid riid, out void *ppvAdapter)
            {
                fixed (void **ppvAdapterLocal = &ppvAdapter)
                {
                    fixed (global::System.Guid*riidLocal = &riid)
                    {
                        win32.System.Com.HRESULT __result = this.EnumAdapterByGpuPreference(Adapter, GpuPreference, riidLocal, ppvAdapterLocal);
                        return __result;
                    }
                }
            }
            ...
            /// <para>The index of the adapter to enumerate. The indices are in order of the preference specified in <i>GpuPreference</i>—for example, if <b>DXGI_GPU_PREFERENCE_HIGH_PERFORMANCE</b> is specified, then the highest-performing adapter is at index 0, the second-highest is at index 1, and so on.</para>
            ...
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/win32/api/dxgi1_6/ne-dxgi1_6-dxgi_gpu_preference">DXGI_GPU_PREFERENCE</a></b></para>
            /// <para>The GPU preference for the app.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_6/nf-dxgi1_6-idxgifactory6-enumadapterbygpupreference#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "riid">
            /// <para>Type: <b>REFIID</b></para>
            /// <para>The globally unique identifier (GUID) of the <a href = "https://docs.microsoft.com/windows/win32/api/dxgi1_6/nn-dxgi1_6-idxgifactory6">IDXGIAdapter</a> object referenced by the <i>ppvAdapter</i> parameter.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_6/nf-dxgi1_6-idxgifactory6-enumadapterbygpupreference#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "ppvAdapter">
            /// <para>Type: <b>void**</b></para>
            /// <para>The address of an <a href = "https://docs.microsoft.com/windows/win32/api/dxgi/nn-dxgi-idxgiadapter">IDXGIAdapter</a> interface pointer to the adapter.</para>
            /// <para>This parameter must not be NULL.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_6/nf-dxgi1_6-idxgifactory6-enumadapterbygpupreference#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b></para>
            /// <para>Returns <b>S_OK</b> if successful; an error code otherwise. For a list of error codes, see <a href = "/windows/win32/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.</para>
            /// </returns>
            /// <remarks>
            ...
            /// </remarks>
            internal unsafe win32.System.Com.HRESULT EnumAdapterByGpuPreference(uint Adapter, win32.Graphics.Dxgi.DXGI_GPU_PREFERENCE GpuPreference, global::System.Guid*riid, void **ppvAdapter)
            {
                fixed (IDXGIFactory6*pThis = &this)
                    return lpVtbl->EnumAdapterByGpuPreference_30(pThis, Adapter, GpuPreference, riid, ppvAdapter);
            }

            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, global::System.Guid*, uint, void *, win32.System.Com.HRESULT>SetPrivateData_4;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, global::System.Guid*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>SetPrivateDataInterface_5;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, global::System.Guid*, uint *, void *, win32.System.Com.HRESULT>GetPrivateData_6;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, global::System.Guid*, void **, win32.System.Com.HRESULT>GetParent_7;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, uint, win32.Graphics.Dxgi.IDXGIAdapter**, win32.System.Com.HRESULT>EnumAdapters_8;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.UI.WindowsAndMessaging.HWND, uint, win32.System.Com.HRESULT>MakeWindowAssociation_9;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.UI.WindowsAndMessaging.HWND*, win32.System.Com.HRESULT>GetWindowAssociation_10;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.Com.IUnknown*, win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC*, win32.Graphics.Dxgi.IDXGISwapChain**, win32.System.Com.HRESULT>CreateSwapChain_11;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.SystemServices.HINSTANCE, win32.Graphics.Dxgi.IDXGIAdapter**, win32.System.Com.HRESULT>CreateSoftwareAdapter_12;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, uint, win32.Graphics.Dxgi.IDXGIAdapter1**, win32.System.Com.HRESULT>EnumAdapters1_13;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.SystemServices.BOOL>IsCurrent_14;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.SystemServices.BOOL>IsWindowedStereoEnabled_15;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.Com.IUnknown*, win32.UI.WindowsAndMessaging.HWND, win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1*, win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_FULLSCREEN_DESC*, win32.Graphics.Dxgi.IDXGIOutput*, win32.Graphics.Dxgi.IDXGISwapChain1**, win32.System.Com.HRESULT>CreateSwapChainForHwnd_16;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.Com.IUnknown*, win32.System.Com.IUnknown*, win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1*, win32.Graphics.Dxgi.IDXGIOutput*, win32.Graphics.Dxgi.IDXGISwapChain1**, win32.System.Com.HRESULT>CreateSwapChainForCoreWindow_17;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.SystemServices.HANDLE, win32.System.SystemServices.LUID*, win32.System.Com.HRESULT>GetSharedResourceAdapterLuid_18;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.UI.WindowsAndMessaging.HWND, uint, uint *, win32.System.Com.HRESULT>RegisterStereoStatusWindow_19;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.SystemServices.HANDLE, uint *, win32.System.Com.HRESULT>RegisterStereoStatusEvent_20;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, uint, void>UnregisterStereoStatus_21;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.UI.WindowsAndMessaging.HWND, uint, uint *, win32.System.Com.HRESULT>RegisterOcclusionStatusWindow_22;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.SystemServices.HANDLE, uint *, win32.System.Com.HRESULT>RegisterOcclusionStatusEvent_23;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, uint, void>UnregisterOcclusionStatus_24;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.Com.IUnknown*, win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1*, win32.Graphics.Dxgi.IDXGIOutput*, win32.Graphics.Dxgi.IDXGISwapChain1**, win32.System.Com.HRESULT>CreateSwapChainForComposition_25;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, uint>GetCreationFlags_26;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.System.SystemServices.LUID, global::System.Guid*, void **, win32.System.Com.HRESULT>EnumAdapterByLuid_27;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, global::System.Guid*, void **, win32.System.Com.HRESULT>EnumWarpAdapter_28;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, win32.Graphics.Dxgi.DXGI_FEATURE, void *, uint, win32.System.Com.HRESULT>CheckFeatureSupport_29;
                internal delegate *unmanaged[Stdcall]<IDXGIFactory6*, uint, win32.Graphics.Dxgi.DXGI_GPU_PREFERENCE, global::System.Guid*, void **, win32.System.Com.HRESULT>EnumAdapterByGpuPreference_30;
            }
