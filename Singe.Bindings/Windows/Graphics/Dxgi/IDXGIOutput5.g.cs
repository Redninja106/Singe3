...
namespace Windows.Win32
{
    ...
    namespace Graphics.Dxgi
    {
        ...
        internal unsafe struct IDXGIOutput5
        {
            ...
            /// <para>Type: <b>const <a href = "https://docs.microsoft.com/windows/desktop/api/dxgiformat/ne-dxgiformat-dxgi_format">DXGI_FORMAT</a>*</b></para>
            /// <para>Specifies an array, of length  <i>SupportedFormatsCount</i> of  <a href = "https://docs.microsoft.com/windows/desktop/api/dxgiformat/ne-dxgiformat-dxgi_format">DXGI_FORMAT</a> entries.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgioutput5-duplicateoutput1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "ppOutputDuplication">
            /// <para>Type: <b>IDXGIOutputDuplication**</b></para>
            /// <para>A pointer to a variable that receives the new <a href = "https://docs.microsoft.com/windows/desktop/api/dxgi1_2/nn-dxgi1_2-idxgioutputduplication">IDXGIOutputDuplication</a> interface.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgioutput5-duplicateoutput1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, global::System.Guid*, uint, void *, win32.System.Com.HRESULT>SetPrivateData_4;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, global::System.Guid*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>SetPrivateDataInterface_5;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, global::System.Guid*, uint *, void *, win32.System.Com.HRESULT>GetPrivateData_6;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, global::System.Guid*, void **, win32.System.Com.HRESULT>GetParent_7;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_OUTPUT_DESC*, win32.System.Com.HRESULT>GetDesc_8;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_FORMAT, uint, uint *, win32.Graphics.Dxgi.DXGI_MODE_DESC*, win32.System.Com.HRESULT>GetDisplayModeList_9;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_MODE_DESC*, win32.Graphics.Dxgi.DXGI_MODE_DESC*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>FindClosestMatchingMode_10;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.System.Com.HRESULT>WaitForVBlank_11;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.System.Com.IUnknown*, win32.System.SystemServices.BOOL, win32.System.Com.HRESULT>TakeOwnership_12;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, void>ReleaseOwnership_13;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_GAMMA_CONTROL_CAPABILITIES*, win32.System.Com.HRESULT>GetGammaControlCapabilities_14;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_GAMMA_CONTROL*, win32.System.Com.HRESULT>SetGammaControl_15;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_GAMMA_CONTROL*, win32.System.Com.HRESULT>GetGammaControl_16;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.IDXGISurface*, win32.System.Com.HRESULT>SetDisplaySurface_17;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.IDXGISurface*, win32.System.Com.HRESULT>GetDisplaySurfaceData_18;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_FRAME_STATISTICS*, win32.System.Com.HRESULT>GetFrameStatistics_19;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_FORMAT, uint, uint *, win32.Graphics.Dxgi.DXGI_MODE_DESC1*, win32.System.Com.HRESULT>GetDisplayModeList1_20;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_MODE_DESC1*, win32.Graphics.Dxgi.DXGI_MODE_DESC1*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>FindClosestMatchingMode1_21;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.IDXGIResource*, win32.System.Com.HRESULT>GetDisplaySurfaceData1_22;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.System.Com.IUnknown*, win32.Graphics.Dxgi.IDXGIOutputDuplication**, win32.System.Com.HRESULT>DuplicateOutput_23;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.System.SystemServices.BOOL>SupportsOverlays_24;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_FORMAT, win32.System.Com.IUnknown*, uint *, win32.System.Com.HRESULT>CheckOverlaySupport_25;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.Graphics.Dxgi.DXGI_FORMAT, win32.Graphics.Dxgi.DXGI_COLOR_SPACE_TYPE, win32.System.Com.IUnknown*, uint *, win32.System.Com.HRESULT>CheckOverlayColorSpaceSupport_26;
                internal delegate *unmanaged[Stdcall]<IDXGIOutput5*, win32.System.Com.IUnknown*, uint, uint, win32.Graphics.Dxgi.DXGI_FORMAT*, win32.Graphics.Dxgi.IDXGIOutputDuplication**, win32.System.Com.HRESULT>DuplicateOutput1_27;
            }
