...
namespace Windows.Win32
{
    ...
    namespace Graphics.Dxgi
    {
        ...
        internal unsafe struct IDXGIDevice4
        {
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-offerresources1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "ppResources">
            /// <para>Type: <b>IDXGIResource*</b></para>
            /// <para>An array of pointers to <a href = "https://docs.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgiresource">IDXGIResource</a> interfaces for the resources to offer.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-offerresources1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "Priority">
            /// <para>Type: <b>DXGI_OFFER_RESOURCE_PRIORITY</b></para>
            /// <para>A <a href = "https://docs.microsoft.com/windows/desktop/api/dxgi1_2/ne-dxgi1_2-dxgi_offer_resource_priority">DXGI_OFFER_RESOURCE_PRIORITY</a>-typed value that indicates how valuable data is.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-offerresources1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "Flags">
            /// <para>Type: <b>UINT</b></para>
            /// <para>Specifies the <a href = "https://docs.microsoft.com/windows/desktop/api/dxgi1_5/ne-dxgi1_5-dxgi_offer_resource_flags">DXGI_OFFER_RESOURCE_FLAGS</a>.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-offerresources1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-offerresources1">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            internal unsafe win32.System.Com.HRESULT OfferResources1(uint NumResources, win32.Graphics.Dxgi.IDXGIResource**ppResources, win32.Graphics.Dxgi.DXGI_OFFER_RESOURCE_PRIORITY Priority, uint Flags)
            {
                fixed (IDXGIDevice4*pThis = &this)
                    return lpVtbl->OfferResources1_19(pThis, NumResources, ppResources, Priority, Flags);
            }

            /// <inheritdoc cref = "ReclaimResources1(uint, win32.Graphics.Dxgi.IDXGIResource**, win32.Graphics.Dxgi.DXGI_RECLAIM_RESOURCE_RESULTS*)"/>
            internal unsafe win32.System.Com.HRESULT ReclaimResources1(uint NumResources, win32.Graphics.Dxgi.IDXGIResource**ppResources, out win32.Graphics.Dxgi.DXGI_RECLAIM_RESOURCE_RESULTS pResults)
            {
                fixed (win32.Graphics.Dxgi.DXGI_RECLAIM_RESOURCE_RESULTS*pResultsLocal = &pResults)
                {
                    win32.System.Com.HRESULT __result = this.ReclaimResources1(NumResources, ppResources, pResultsLocal);
                    return __result;
                }
            }
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-reclaimresources1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "ppResources">
            /// <para>Type: <b>IDXGIResource*</b></para>
            /// <para>An array of pointers to <a href = "https://docs.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgiresource">IDXGIResource</a> interfaces for the resources to reclaim.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-reclaimresources1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "pResults">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/dxgi1_5/ne-dxgi1_5-dxgi_reclaim_resource_results">DXGI_RECLAIM_RESOURCE_RESULTS</a>*</b></para>
            /// <para>A pointer to an array that receives <a href = "https://docs.microsoft.com/windows/desktop/api/dxgi1_5/ne-dxgi1_5-dxgi_reclaim_resource_results">DXGI_RECLAIM_RESOURCE_RESULTS</a> values. Each value in the array corresponds to a resource at the same index that the <i>ppResources</i> parameter specifies.  The caller can pass in <b>NULL</b>, if the caller intends to fill the resources with new content regardless of whether the old content was discarded.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-reclaimresources1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            /// <para>Type: <b><a href = "/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b></para>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//dxgi1_5/nf-dxgi1_5-idxgidevice4-reclaimresources1">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            internal unsafe win32.System.Com.HRESULT ReclaimResources1(uint NumResources, win32.Graphics.Dxgi.IDXGIResource**ppResources, win32.Graphics.Dxgi.DXGI_RECLAIM_RESOURCE_RESULTS*pResults)
            {
                fixed (IDXGIDevice4*pThis = &this)
                    return lpVtbl->ReclaimResources1_20(pThis, NumResources, ppResources, pResults);
            }

            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, global::System.Guid*, uint, void *, win32.System.Com.HRESULT>SetPrivateData_4;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, global::System.Guid*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>SetPrivateDataInterface_5;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, global::System.Guid*, uint *, void *, win32.System.Com.HRESULT>GetPrivateData_6;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, global::System.Guid*, void **, win32.System.Com.HRESULT>GetParent_7;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, win32.Graphics.Dxgi.IDXGIAdapter**, win32.System.Com.HRESULT>GetAdapter_8;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, win32.Graphics.Dxgi.DXGI_SURFACE_DESC*, uint, uint, win32.Graphics.Dxgi.DXGI_SHARED_RESOURCE*, win32.Graphics.Dxgi.IDXGISurface**, win32.System.Com.HRESULT>CreateSurface_9;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, win32.System.Com.IUnknown**, win32.Graphics.Dxgi.DXGI_RESIDENCY*, uint, win32.System.Com.HRESULT>QueryResourceResidency_10;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, int, win32.System.Com.HRESULT>SetGPUThreadPriority_11;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, int *, win32.System.Com.HRESULT>GetGPUThreadPriority_12;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, uint, win32.System.Com.HRESULT>SetMaximumFrameLatency_13;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, uint *, win32.System.Com.HRESULT>GetMaximumFrameLatency_14;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, uint, win32.Graphics.Dxgi.IDXGIResource**, win32.Graphics.Dxgi.DXGI_OFFER_RESOURCE_PRIORITY, win32.System.Com.HRESULT>OfferResources_15;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, uint, win32.Graphics.Dxgi.IDXGIResource**, win32.System.SystemServices.BOOL*, win32.System.Com.HRESULT>ReclaimResources_16;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, win32.System.SystemServices.HANDLE, win32.System.Com.HRESULT>EnqueueSetEvent_17;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, void>Trim_18;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, uint, win32.Graphics.Dxgi.IDXGIResource**, win32.Graphics.Dxgi.DXGI_OFFER_RESOURCE_PRIORITY, uint, win32.System.Com.HRESULT>OfferResources1_19;
                internal delegate *unmanaged[Stdcall]<IDXGIDevice4*, uint, win32.Graphics.Dxgi.IDXGIResource**, win32.Graphics.Dxgi.DXGI_RECLAIM_RESOURCE_RESULTS*, win32.System.Com.HRESULT>ReclaimResources1_20;
            }
