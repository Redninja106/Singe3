...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct3D11
    {
        ...
        internal unsafe struct ID3D11Device2
        {
            ...
            {
                fixed (ID3D11Device2*pThis = &this)
            ...
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_2/nn-d3d11_2-id3d11devicecontext2">ID3D11DeviceContext2</a>**</b></para>
            /// <para>Upon completion of the method, the passed pointer to an <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_2/nn-d3d11_2-id3d11devicecontext2">ID3D11DeviceContext2</a> interface pointer is initialized.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-getimmediatecontext2#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <remarks>
            /// <para>The <b>GetImmediateContext2</b> method returns an <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_2/nn-d3d11_2-id3d11devicecontext2">ID3D11DeviceContext2</a> object that represents an immediate context, which is used to perform rendering that you want immediately submitted to a device. For most apps, an immediate context is the primary object that is used to draw your scene.</para>
            /// <para>The <b>GetImmediateContext2</b> method increments the reference count of the immediate context by one. Therefore, you must call <a href = "https://docs.microsoft.com/windows/desktop/api/unknwn/nf-unknwn-iunknown-release">Release</a> on the returned interface pointer when you are done with it to avoid a memory leak.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-getimmediatecontext2#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-createdeferredcontext2#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-createdeferredcontext2">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-getresourcetiling#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            ...
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_2/ns-d3d11_2-d3d11_packed_mip_desc">D3D11_PACKED_MIP_DESC</a>*</b></para>
            /// <para>A pointer to a <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_2/ns-d3d11_2-d3d11_packed_mip_desc">D3D11_PACKED_MIP_DESC</a> structure that <b>GetResourceTiling</b> fills with info about how the tiled resource's mipmaps are packed.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-getresourcetiling#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "pStandardTileShapeForNonPackedMips">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_2/ns-d3d11_2-d3d11_tile_shape">D3D11_TILE_SHAPE</a>*</b></para>
            /// <para>A pointer to a <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_2/ns-d3d11_2-d3d11_tile_shape">D3D11_TILE_SHAPE</a> structure that <b>GetResourceTiling</b> fills with info about the tile shape. This is info about how pixels fit in the tiles, independent of tiled resource's dimensions, not including packed mipmaps.  If the entire tiled resource is packed, this parameter is meaningless because the tiled resource has no defined layout for packed mipmaps. In this situation, <b>GetResourceTiling</b> sets the members of <b>D3D11_TILE_SHAPE</b> to zeros.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-getresourcetiling#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-getresourcetiling#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-checkmultisamplequalitylevels1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_2/nf-d3d11_2-id3d11device2-checkmultisamplequalitylevels1">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_BUFFER_DESC*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Buffer**, win32.System.Com.HRESULT>CreateBuffer_4;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_TEXTURE1D_DESC*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Texture1D**, win32.System.Com.HRESULT>CreateTexture1D_5;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_TEXTURE2D_DESC*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Texture2D**, win32.System.Com.HRESULT>CreateTexture2D_6;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_TEXTURE3D_DESC*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Texture3D**, win32.System.Com.HRESULT>CreateTexture3D_7;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_SHADER_RESOURCE_VIEW_DESC*, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, win32.System.Com.HRESULT>CreateShaderResourceView_8;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_UNORDERED_ACCESS_VIEW_DESC*, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView**, win32.System.Com.HRESULT>CreateUnorderedAccessView_9;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_RENDER_TARGET_VIEW_DESC*, win32.Graphics.Direct3D11.ID3D11RenderTargetView**, win32.System.Com.HRESULT>CreateRenderTargetView_10;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_DEPTH_STENCIL_VIEW_DESC*, win32.Graphics.Direct3D11.ID3D11DepthStencilView**, win32.System.Com.HRESULT>CreateDepthStencilView_11;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_INPUT_ELEMENT_DESC*, uint, void *, nuint, win32.Graphics.Direct3D11.ID3D11InputLayout**, win32.System.Com.HRESULT>CreateInputLayout_12;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11VertexShader**, win32.System.Com.HRESULT>CreateVertexShader_13;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11GeometryShader**, win32.System.Com.HRESULT>CreateGeometryShader_14;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, void *, nuint, win32.Graphics.Direct3D11.D3D11_SO_DECLARATION_ENTRY*, uint, uint *, uint, uint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11GeometryShader**, win32.System.Com.HRESULT>CreateGeometryShaderWithStreamOutput_15;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11PixelShader**, win32.System.Com.HRESULT>CreatePixelShader_16;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11HullShader**, win32.System.Com.HRESULT>CreateHullShader_17;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11DomainShader**, win32.System.Com.HRESULT>CreateDomainShader_18;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11ComputeShader**, win32.System.Com.HRESULT>CreateComputeShader_19;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11ClassLinkage**, win32.System.Com.HRESULT>CreateClassLinkage_20;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_BLEND_DESC*, win32.Graphics.Direct3D11.ID3D11BlendState**, win32.System.Com.HRESULT>CreateBlendState_21;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_DEPTH_STENCIL_DESC*, win32.Graphics.Direct3D11.ID3D11DepthStencilState**, win32.System.Com.HRESULT>CreateDepthStencilState_22;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_RASTERIZER_DESC*, win32.Graphics.Direct3D11.ID3D11RasterizerState**, win32.System.Com.HRESULT>CreateRasterizerState_23;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_SAMPLER_DESC*, win32.Graphics.Direct3D11.ID3D11SamplerState**, win32.System.Com.HRESULT>CreateSamplerState_24;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_QUERY_DESC*, win32.Graphics.Direct3D11.ID3D11Query**, win32.System.Com.HRESULT>CreateQuery_25;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_QUERY_DESC*, win32.Graphics.Direct3D11.ID3D11Predicate**, win32.System.Com.HRESULT>CreatePredicate_26;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_COUNTER_DESC*, win32.Graphics.Direct3D11.ID3D11Counter**, win32.System.Com.HRESULT>CreateCounter_27;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint, win32.Graphics.Direct3D11.ID3D11DeviceContext**, win32.System.Com.HRESULT>CreateDeferredContext_28;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.System.SystemServices.HANDLE, global::System.Guid*, void **, win32.System.Com.HRESULT>OpenSharedResource_29;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Dxgi.DXGI_FORMAT, uint *, win32.System.Com.HRESULT>CheckFormatSupport_30;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Dxgi.DXGI_FORMAT, uint, uint *, win32.System.Com.HRESULT>CheckMultisampleQualityLevels_31;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_COUNTER_INFO*, void>CheckCounterInfo_32;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_COUNTER_DESC*, win32.Graphics.Direct3D11.D3D11_COUNTER_TYPE*, uint *, win32.System.SystemServices.PSTR, uint *, win32.System.SystemServices.PSTR, uint *, win32.System.SystemServices.PSTR, uint *, win32.System.Com.HRESULT>CheckCounter_33;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_FEATURE, void *, uint, win32.System.Com.HRESULT>CheckFeatureSupport_34;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, global::System.Guid*, uint *, void *, win32.System.Com.HRESULT>GetPrivateData_35;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, global::System.Guid*, uint, void *, win32.System.Com.HRESULT>SetPrivateData_36;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, global::System.Guid*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>SetPrivateDataInterface_37;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D_FEATURE_LEVEL>GetFeatureLevel_38;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint>GetCreationFlags_39;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.System.Com.HRESULT>GetDeviceRemovedReason_40;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11DeviceContext**, void>GetImmediateContext_41;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint, win32.System.Com.HRESULT>SetExceptionMode_42;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint>GetExceptionMode_43;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11DeviceContext1**, void>GetImmediateContext1_44;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint, win32.Graphics.Direct3D11.ID3D11DeviceContext1**, win32.System.Com.HRESULT>CreateDeferredContext1_45;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_BLEND_DESC1*, win32.Graphics.Direct3D11.ID3D11BlendState1**, win32.System.Com.HRESULT>CreateBlendState1_46;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.D3D11_RASTERIZER_DESC1*, win32.Graphics.Direct3D11.ID3D11RasterizerState1**, win32.System.Com.HRESULT>CreateRasterizerState1_47;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint, win32.Graphics.Direct3D11.D3D_FEATURE_LEVEL*, uint, uint, global::System.Guid*, win32.Graphics.Direct3D11.D3D_FEATURE_LEVEL*, win32.Graphics.Direct3D11.ID3DDeviceContextState**, win32.System.Com.HRESULT>CreateDeviceContextState_48;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.System.SystemServices.HANDLE, global::System.Guid*, void **, win32.System.Com.HRESULT>OpenSharedResource1_49;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.System.SystemServices.PCWSTR, uint, global::System.Guid*, void **, win32.System.Com.HRESULT>OpenSharedResourceByName_50;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11DeviceContext2**, void>GetImmediateContext2_51;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, uint, win32.Graphics.Direct3D11.ID3D11DeviceContext2**, win32.System.Com.HRESULT>CreateDeferredContext2_52;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Direct3D11.ID3D11Resource*, uint *, win32.Graphics.Direct3D11.D3D11_PACKED_MIP_DESC*, win32.Graphics.Direct3D11.D3D11_TILE_SHAPE*, uint *, uint, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_TILING*, void>GetResourceTiling_53;
                internal delegate *unmanaged[Stdcall]<ID3D11Device2*, win32.Graphics.Dxgi.DXGI_FORMAT, uint, uint, uint *, win32.System.Com.HRESULT>CheckMultisampleQualityLevels1_54;
            }
