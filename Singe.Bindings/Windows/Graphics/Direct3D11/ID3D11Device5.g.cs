...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct3D11
    {
        ...
        internal unsafe struct ID3D11Device5
        {
            ...
            {
                fixed (ID3D11Device5*pThis = &this)
            ...
            /// <inheritdoc cref = "OpenSharedFence(win32.System.SystemServices.HANDLE, global::System.Guid*, void **)"/>
            internal unsafe win32.System.Com.HRESULT OpenSharedFence(SafeHandle hFence, in global::System.Guid ReturnedInterface, void **ppFence)
            {
                bool hFenceAddRef = false;
                try
                {
                    fixed (global::System.Guid*ReturnedInterfaceLocal = &ReturnedInterface)
                    {
                        win32.System.SystemServices.HANDLE hFenceLocal;
                        if (hFence is object)
                        {
                            hFence.DangerousAddRef(ref hFenceAddRef);
                            hFenceLocal = (win32.System.SystemServices.HANDLE)hFence.DangerousGetHandle();
                        }
                        else
                            hFenceLocal = default(win32.System.SystemServices.HANDLE);
                        win32.System.Com.HRESULT __result = this.OpenSharedFence(hFenceLocal, ReturnedInterfaceLocal, ppFence);
                        return __result;
                    }
                }
                finally
                {
                    if (hFenceAddRef)
                        hFence.DangerousRelease();
                }
            }

            /// <summary>Opens a handle for a shared fence by using HANDLE and REFIID.</summary>
            /// <param name = "hFence">
            /// <para>Type: <b>HANDLE</b></para>
            /// <para>The handle that was returned by a call to <a href = "https://docs.microsoft.com/windows/win32/api/d3d11_3/nf-d3d11_3-id3d11fence-createsharedhandle">ID3D11Fence::CreateSharedHandle</a> or <a href = "https://docs.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12device-createsharedhandle">ID3D12Device::CreateSharedHandle</a>.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-opensharedfence#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "ReturnedInterface">
            /// <para>Type: <b>REFIID</b></para>
            /// <para>The globally unique identifier (<b>GUID</b>) for the <a href = "https://docs.microsoft.com/windows/win32/api/d3d11_3/nn-d3d11_3-id3d11fence">ID3D11Fence</a> interface. The <b>REFIID</b>, or <b>GUID</b>, of the interface can be obtained by using the __uuidof() macro. For example, __uuidof(ID3D11Fence) will get the <b>GUID</b> of the interface to the fence.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-opensharedfence#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "ppFence">
            /// <para>Type: <b>void**</b></para>
            /// <para>A pointer to a memory block that receives a pointer to the <a href = "https://docs.microsoft.com/windows/win32/api/d3d11_3/nn-d3d11_3-id3d11fence">ID3D11Fence</a> interface.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-opensharedfence#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-opensharedfence">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            internal unsafe win32.System.Com.HRESULT OpenSharedFence(win32.System.SystemServices.HANDLE hFence, global::System.Guid*ReturnedInterface, [Optional] void **ppFence)
            {
                fixed (ID3D11Device5*pThis = &this)
                    return lpVtbl->OpenSharedFence_68(pThis, hFence, ReturnedInterface, ppFence);
            }

            /// <inheritdoc cref = "CreateFence(ulong, win32.Graphics.Direct3D11.D3D11_FENCE_FLAG, global::System.Guid*, void **)"/>
            internal unsafe win32.System.Com.HRESULT CreateFence(ulong InitialValue, win32.Graphics.Direct3D11.D3D11_FENCE_FLAG Flags, in global::System.Guid ReturnedInterface, void **ppFence)
            {
                fixed (global::System.Guid*ReturnedInterfaceLocal = &ReturnedInterface)
                {
                    win32.System.Com.HRESULT __result = this.CreateFence(InitialValue, Flags, ReturnedInterfaceLocal, ppFence);
                    return __result;
                }
            }
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-createfence#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "Flags">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_3/ne-d3d11_3-d3d11_fence_flag">D3D11_FENCE_FLAG</a></b></para>
            /// <para>A combination of <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_3/ne-d3d11_3-d3d11_fence_flag">D3D11_FENCE_FLAG</a>-typed values that are combined by using a bitwise OR operation. The resulting value specifies options for the fence.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-createfence#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "ReturnedInterface">
            /// <para>Type: <b>REFIID</b></para>
            /// <para>The globally unique identifier (<b>GUID</b>) for the fence interface (<a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11fence">ID3D11Fence</a>). The <b>REFIID</b>, or <b>GUID</b>, of the interface to the fence can be obtained by using the __uuidof() macro. For example, __uuidof(ID3D11Fence) will get the <b>GUID</b> of the interface to a fence.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-createfence#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "ppFence">
            /// <para>Type: <b>void**</b></para>
            /// <para>A pointer to a memory block that receives a pointer to the <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11fence">ID3D11Fence</a> interface that is used to access the fence.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-createfence#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            /// <para>Type: <b><a href = "/windows/desktop/WinProg/windows-data-types">HRESULT</a></b></para>
            /// <para>Returns <b>S_OK</b> if successful; otherwise, returns one of the <a href = "/windows/desktop/direct3d11/d3d11-graphics-reference-returnvalues">Direct3D 11 Return Codes</a>.</para>
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_4/nf-d3d11_4-id3d11device5-createfence">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            internal unsafe win32.System.Com.HRESULT CreateFence(ulong InitialValue, win32.Graphics.Direct3D11.D3D11_FENCE_FLAG Flags, global::System.Guid*ReturnedInterface, [Optional] void **ppFence)
            {
                fixed (ID3D11Device5*pThis = &this)
                    return lpVtbl->CreateFence_69(pThis, InitialValue, Flags, ReturnedInterface, ppFence);
            }

            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_BUFFER_DESC*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Buffer**, win32.System.Com.HRESULT>CreateBuffer_4;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_TEXTURE1D_DESC*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Texture1D**, win32.System.Com.HRESULT>CreateTexture1D_5;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_TEXTURE2D_DESC*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Texture2D**, win32.System.Com.HRESULT>CreateTexture2D_6;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_TEXTURE3D_DESC*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Texture3D**, win32.System.Com.HRESULT>CreateTexture3D_7;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_SHADER_RESOURCE_VIEW_DESC*, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, win32.System.Com.HRESULT>CreateShaderResourceView_8;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_UNORDERED_ACCESS_VIEW_DESC*, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView**, win32.System.Com.HRESULT>CreateUnorderedAccessView_9;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_RENDER_TARGET_VIEW_DESC*, win32.Graphics.Direct3D11.ID3D11RenderTargetView**, win32.System.Com.HRESULT>CreateRenderTargetView_10;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_DEPTH_STENCIL_VIEW_DESC*, win32.Graphics.Direct3D11.ID3D11DepthStencilView**, win32.System.Com.HRESULT>CreateDepthStencilView_11;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_INPUT_ELEMENT_DESC*, uint, void *, nuint, win32.Graphics.Direct3D11.ID3D11InputLayout**, win32.System.Com.HRESULT>CreateInputLayout_12;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11VertexShader**, win32.System.Com.HRESULT>CreateVertexShader_13;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11GeometryShader**, win32.System.Com.HRESULT>CreateGeometryShader_14;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, void *, nuint, win32.Graphics.Direct3D11.D3D11_SO_DECLARATION_ENTRY*, uint, uint *, uint, uint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11GeometryShader**, win32.System.Com.HRESULT>CreateGeometryShaderWithStreamOutput_15;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11PixelShader**, win32.System.Com.HRESULT>CreatePixelShader_16;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11HullShader**, win32.System.Com.HRESULT>CreateHullShader_17;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11DomainShader**, win32.System.Com.HRESULT>CreateDomainShader_18;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, void *, nuint, win32.Graphics.Direct3D11.ID3D11ClassLinkage*, win32.Graphics.Direct3D11.ID3D11ComputeShader**, win32.System.Com.HRESULT>CreateComputeShader_19;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11ClassLinkage**, win32.System.Com.HRESULT>CreateClassLinkage_20;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_BLEND_DESC*, win32.Graphics.Direct3D11.ID3D11BlendState**, win32.System.Com.HRESULT>CreateBlendState_21;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_DEPTH_STENCIL_DESC*, win32.Graphics.Direct3D11.ID3D11DepthStencilState**, win32.System.Com.HRESULT>CreateDepthStencilState_22;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_RASTERIZER_DESC*, win32.Graphics.Direct3D11.ID3D11RasterizerState**, win32.System.Com.HRESULT>CreateRasterizerState_23;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_SAMPLER_DESC*, win32.Graphics.Direct3D11.ID3D11SamplerState**, win32.System.Com.HRESULT>CreateSamplerState_24;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_QUERY_DESC*, win32.Graphics.Direct3D11.ID3D11Query**, win32.System.Com.HRESULT>CreateQuery_25;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_QUERY_DESC*, win32.Graphics.Direct3D11.ID3D11Predicate**, win32.System.Com.HRESULT>CreatePredicate_26;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_COUNTER_DESC*, win32.Graphics.Direct3D11.ID3D11Counter**, win32.System.Com.HRESULT>CreateCounter_27;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint, win32.Graphics.Direct3D11.ID3D11DeviceContext**, win32.System.Com.HRESULT>CreateDeferredContext_28;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.System.SystemServices.HANDLE, global::System.Guid*, void **, win32.System.Com.HRESULT>OpenSharedResource_29;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Dxgi.DXGI_FORMAT, uint *, win32.System.Com.HRESULT>CheckFormatSupport_30;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Dxgi.DXGI_FORMAT, uint, uint *, win32.System.Com.HRESULT>CheckMultisampleQualityLevels_31;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_COUNTER_INFO*, void>CheckCounterInfo_32;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_COUNTER_DESC*, win32.Graphics.Direct3D11.D3D11_COUNTER_TYPE*, uint *, win32.System.SystemServices.PSTR, uint *, win32.System.SystemServices.PSTR, uint *, win32.System.SystemServices.PSTR, uint *, win32.System.Com.HRESULT>CheckCounter_33;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_FEATURE, void *, uint, win32.System.Com.HRESULT>CheckFeatureSupport_34;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, global::System.Guid*, uint *, void *, win32.System.Com.HRESULT>GetPrivateData_35;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, global::System.Guid*, uint, void *, win32.System.Com.HRESULT>SetPrivateData_36;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, global::System.Guid*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>SetPrivateDataInterface_37;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D_FEATURE_LEVEL>GetFeatureLevel_38;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint>GetCreationFlags_39;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.System.Com.HRESULT>GetDeviceRemovedReason_40;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11DeviceContext**, void>GetImmediateContext_41;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint, win32.System.Com.HRESULT>SetExceptionMode_42;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint>GetExceptionMode_43;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11DeviceContext1**, void>GetImmediateContext1_44;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint, win32.Graphics.Direct3D11.ID3D11DeviceContext1**, win32.System.Com.HRESULT>CreateDeferredContext1_45;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_BLEND_DESC1*, win32.Graphics.Direct3D11.ID3D11BlendState1**, win32.System.Com.HRESULT>CreateBlendState1_46;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_RASTERIZER_DESC1*, win32.Graphics.Direct3D11.ID3D11RasterizerState1**, win32.System.Com.HRESULT>CreateRasterizerState1_47;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint, win32.Graphics.Direct3D11.D3D_FEATURE_LEVEL*, uint, uint, global::System.Guid*, win32.Graphics.Direct3D11.D3D_FEATURE_LEVEL*, win32.Graphics.Direct3D11.ID3DDeviceContextState**, win32.System.Com.HRESULT>CreateDeviceContextState_48;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.System.SystemServices.HANDLE, global::System.Guid*, void **, win32.System.Com.HRESULT>OpenSharedResource1_49;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.System.SystemServices.PCWSTR, uint, global::System.Guid*, void **, win32.System.Com.HRESULT>OpenSharedResourceByName_50;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11DeviceContext2**, void>GetImmediateContext2_51;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint, win32.Graphics.Direct3D11.ID3D11DeviceContext2**, win32.System.Com.HRESULT>CreateDeferredContext2_52;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, uint *, win32.Graphics.Direct3D11.D3D11_PACKED_MIP_DESC*, win32.Graphics.Direct3D11.D3D11_TILE_SHAPE*, uint *, uint, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_TILING*, void>GetResourceTiling_53;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Dxgi.DXGI_FORMAT, uint, uint, uint *, win32.System.Com.HRESULT>CheckMultisampleQualityLevels1_54;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_TEXTURE2D_DESC1*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Texture2D1**, win32.System.Com.HRESULT>CreateTexture2D1_55;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_TEXTURE3D_DESC1*, win32.Graphics.Direct3D11.D3D11_SUBRESOURCE_DATA*, win32.Graphics.Direct3D11.ID3D11Texture3D1**, win32.System.Com.HRESULT>CreateTexture3D1_56;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_RASTERIZER_DESC2*, win32.Graphics.Direct3D11.ID3D11RasterizerState2**, win32.System.Com.HRESULT>CreateRasterizerState2_57;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_SHADER_RESOURCE_VIEW_DESC1*, win32.Graphics.Direct3D11.ID3D11ShaderResourceView1**, win32.System.Com.HRESULT>CreateShaderResourceView1_58;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_UNORDERED_ACCESS_VIEW_DESC1*, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView1**, win32.System.Com.HRESULT>CreateUnorderedAccessView1_59;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_RENDER_TARGET_VIEW_DESC1*, win32.Graphics.Direct3D11.ID3D11RenderTargetView1**, win32.System.Com.HRESULT>CreateRenderTargetView1_60;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.D3D11_QUERY_DESC1*, win32.Graphics.Direct3D11.ID3D11Query1**, win32.System.Com.HRESULT>CreateQuery1_61;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11DeviceContext3**, void>GetImmediateContext3_62;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint, win32.Graphics.Direct3D11.ID3D11DeviceContext3**, win32.System.Com.HRESULT>CreateDeferredContext3_63;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.D3D11_BOX*, void *, uint, uint, void>WriteToSubresource_64;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, void *, uint, uint, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.D3D11_BOX*, void>ReadFromSubresource_65;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.System.SystemServices.HANDLE, uint *, win32.System.Com.HRESULT>RegisterDeviceRemovedEvent_66;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, uint, void>UnregisterDeviceRemoved_67;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, win32.System.SystemServices.HANDLE, global::System.Guid*, void **, win32.System.Com.HRESULT>OpenSharedFence_68;
                internal delegate *unmanaged[Stdcall]<ID3D11Device5*, ulong, win32.Graphics.Direct3D11.D3D11_FENCE_FLAG, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateFence_69;
            }
