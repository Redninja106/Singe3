...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct3D11
    {
        ...
        internal unsafe struct ID3D11DeviceContext3
        {
            ...
            {
                fixed (ID3D11DeviceContext3*pThis = &this)
            ...
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_3/ne-d3d11_3-d3d11_context_type">D3D11_CONTEXT_TYPE</a></b></para>
            /// <para>A <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11_3/ne-d3d11_3-d3d11_context_type">D3D11_CONTEXT_TYPE</a> that specifies the context in which a query occurs, such as a 3D command queue, 3D compute queue, 3D copy queue, video, or image.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_3/nf-d3d11_3-id3d11devicecontext3-flush1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "hEvent">
            /// <para>Type: <b>HANDLE</b> An optional event handle. When specified, this method creates an event query.</para>
            /// <para><b>Flush1</b> operates asynchronously, therefore it can return either before or after the GPU finishes executing the queued graphics commands, which will eventually complete. To create an event query, you can call <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11device-createquery">ID3D11Device::CreateQuery</a> with the value <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11/ne-d3d11-d3d11_query">D3D11_QUERY_EVENT</a> value. To determine when the GPU is finished processing the graphics commands, you can then use that event query in a call to <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11devicecontext-getdata">ID3D11DeviceContext::GetData</a>.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_3/nf-d3d11_3-id3d11devicecontext3-flush1#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <remarks>
            /// <para><b>Flush1</b> has parameters. For more information, see <a href = "https://docs.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11devicecontext-flush">ID3D11DeviceContext::Flush</a>, which doesn't have parameters.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_3/nf-d3d11_3-id3d11devicecontext3-flush1#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_3/nf-d3d11_3-id3d11devicecontext3-sethardwareprotectionstate#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_3/nf-d3d11_3-id3d11devicecontext3-sethardwareprotectionstate">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_3/nf-d3d11_3-id3d11devicecontext3-gethardwareprotectionstate#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d11_3/nf-d3d11_3-id3d11devicecontext3-gethardwareprotectionstate">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Device**, void>GetDevice_4;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, global::System.Guid*, uint *, void *, win32.System.Com.HRESULT>GetPrivateData_5;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, global::System.Guid*, uint, void *, win32.System.Com.HRESULT>SetPrivateData_6;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, global::System.Guid*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>SetPrivateDataInterface_7;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>VSSetConstantBuffers_8;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>PSSetShaderResources_9;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11PixelShader*, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint, void>PSSetShader_10;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>PSSetSamplers_11;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11VertexShader*, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint, void>VSSetShader_12;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, int, void>DrawIndexed_13;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, void>Draw_14;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.D3D11_MAP, uint, win32.Graphics.Direct3D11.D3D11_MAPPED_SUBRESOURCE*, win32.System.Com.HRESULT>Map_15;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, void>Unmap_16;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>PSSetConstantBuffers_17;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11InputLayout*, void>IASetInputLayout_18;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>IASetVertexBuffers_19;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Buffer*, win32.Graphics.Dxgi.DXGI_FORMAT, uint, void>IASetIndexBuffer_20;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, uint, int, uint, void>DrawIndexedInstanced_21;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, uint, uint, void>DrawInstanced_22;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>GSSetConstantBuffers_23;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11GeometryShader*, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint, void>GSSetShader_24;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.D3D_PRIMITIVE_TOPOLOGY, void>IASetPrimitiveTopology_25;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>VSSetShaderResources_26;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>VSSetSamplers_27;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Asynchronous*, void>Begin_28;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Asynchronous*, void>End_29;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Asynchronous*, void *, uint, uint, win32.System.Com.HRESULT>GetData_30;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Predicate*, win32.System.SystemServices.BOOL, void>SetPredication_31;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>GSSetShaderResources_32;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>GSSetSamplers_33;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, win32.Graphics.Direct3D11.ID3D11RenderTargetView**, win32.Graphics.Direct3D11.ID3D11DepthStencilView*, void>OMSetRenderTargets_34;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, win32.Graphics.Direct3D11.ID3D11RenderTargetView**, win32.Graphics.Direct3D11.ID3D11DepthStencilView*, uint, uint, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView**, uint *, void>OMSetRenderTargetsAndUnorderedAccessViews_35;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11BlendState*, float *, uint, void>OMSetBlendState_36;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11DepthStencilState*, uint, void>OMSetDepthStencilState_37;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, void>SOSetTargets_38;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, void>DrawAuto_39;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Buffer*, uint, void>DrawIndexedInstancedIndirect_40;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Buffer*, uint, void>DrawInstancedIndirect_41;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, uint, void>Dispatch_42;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Buffer*, uint, void>DispatchIndirect_43;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11RasterizerState*, void>RSSetState_44;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, win32.Graphics.Direct3D11.D3D11_VIEWPORT*, void>RSSetViewports_45;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, win32.UI.DisplayDevices.RECT*, void>RSSetScissorRects_46;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, uint, uint, uint, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.D3D11_BOX*, void>CopySubresourceRegion_47;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.ID3D11Resource*, void>CopyResource_48;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.D3D11_BOX*, void *, uint, uint, void>UpdateSubresource_49;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Buffer*, uint, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView*, void>CopyStructureCount_50;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11RenderTargetView*, float *, void>ClearRenderTargetView_51;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView*, uint *, void>ClearUnorderedAccessViewUint_52;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView*, float *, void>ClearUnorderedAccessViewFloat_53;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11DepthStencilView*, uint, float, byte, void>ClearDepthStencilView_54;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11ShaderResourceView*, void>GenerateMips_55;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, float, void>SetResourceMinLOD_56;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, float>GetResourceMinLOD_57;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Dxgi.DXGI_FORMAT, void>ResolveSubresource_58;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11CommandList*, win32.System.SystemServices.BOOL, void>ExecuteCommandList_59;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>HSSetShaderResources_60;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11HullShader*, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint, void>HSSetShader_61;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>HSSetSamplers_62;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>HSSetConstantBuffers_63;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>DSSetShaderResources_64;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11DomainShader*, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint, void>DSSetShader_65;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>DSSetSamplers_66;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>DSSetConstantBuffers_67;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>CSSetShaderResources_68;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView**, uint *, void>CSSetUnorderedAccessViews_69;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11ComputeShader*, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint, void>CSSetShader_70;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>CSSetSamplers_71;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>CSSetConstantBuffers_72;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>VSGetConstantBuffers_73;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>PSGetShaderResources_74;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11PixelShader**, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint *, void>PSGetShader_75;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>PSGetSamplers_76;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11VertexShader**, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint *, void>VSGetShader_77;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>PSGetConstantBuffers_78;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11InputLayout**, void>IAGetInputLayout_79;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>IAGetVertexBuffers_80;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Buffer**, win32.Graphics.Dxgi.DXGI_FORMAT*, uint *, void>IAGetIndexBuffer_81;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>GSGetConstantBuffers_82;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11GeometryShader**, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint *, void>GSGetShader_83;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.D3D_PRIMITIVE_TOPOLOGY*, void>IAGetPrimitiveTopology_84;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>VSGetShaderResources_85;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>VSGetSamplers_86;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Predicate**, win32.System.SystemServices.BOOL*, void>GetPredication_87;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>GSGetShaderResources_88;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>GSGetSamplers_89;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, win32.Graphics.Direct3D11.ID3D11RenderTargetView**, win32.Graphics.Direct3D11.ID3D11DepthStencilView**, void>OMGetRenderTargets_90;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, win32.Graphics.Direct3D11.ID3D11RenderTargetView**, win32.Graphics.Direct3D11.ID3D11DepthStencilView**, uint, uint, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView**, void>OMGetRenderTargetsAndUnorderedAccessViews_91;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11BlendState**, float *, uint *, void>OMGetBlendState_92;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11DepthStencilState**, uint *, void>OMGetDepthStencilState_93;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>SOGetTargets_94;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11RasterizerState**, void>RSGetState_95;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint *, win32.Graphics.Direct3D11.D3D11_VIEWPORT*, void>RSGetViewports_96;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint *, win32.UI.DisplayDevices.RECT*, void>RSGetScissorRects_97;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>HSGetShaderResources_98;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11HullShader**, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint *, void>HSGetShader_99;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>HSGetSamplers_100;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>HSGetConstantBuffers_101;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>DSGetShaderResources_102;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11DomainShader**, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint *, void>DSGetShader_103;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>DSGetSamplers_104;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>DSGetConstantBuffers_105;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11ShaderResourceView**, void>CSGetShaderResources_106;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11UnorderedAccessView**, void>CSGetUnorderedAccessViews_107;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11ComputeShader**, win32.Graphics.Direct3D11.ID3D11ClassInstance**, uint *, void>CSGetShader_108;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11SamplerState**, void>CSGetSamplers_109;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, void>CSGetConstantBuffers_110;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, void>ClearState_111;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, void>Flush_112;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.D3D11_DEVICE_CONTEXT_TYPE>GetType_113;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint>GetContextFlags_114;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.System.SystemServices.BOOL, win32.Graphics.Direct3D11.ID3D11CommandList**, win32.System.Com.HRESULT>FinishCommandList_115;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, uint, uint, uint, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.D3D11_BOX*, uint, void>CopySubresourceRegion1_116;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.D3D11_BOX*, void *, uint, uint, uint, void>UpdateSubresource1_117;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, void>DiscardResource_118;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11View*, void>DiscardView_119;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>VSSetConstantBuffers1_120;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>HSSetConstantBuffers1_121;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>DSSetConstantBuffers1_122;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>GSSetConstantBuffers1_123;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>PSSetConstantBuffers1_124;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>CSSetConstantBuffers1_125;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>VSGetConstantBuffers1_126;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>HSGetConstantBuffers1_127;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>DSGetConstantBuffers1_128;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>GSGetConstantBuffers1_129;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>PSGetConstantBuffers1_130;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, uint, uint, win32.Graphics.Direct3D11.ID3D11Buffer**, uint *, uint *, void>CSGetConstantBuffers1_131;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3DDeviceContextState*, win32.Graphics.Direct3D11.ID3DDeviceContextState**, void>SwapDeviceContextState_132;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11View*, float *, win32.UI.DisplayDevices.RECT*, uint, void>ClearView_133;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11View*, win32.UI.DisplayDevices.RECT*, uint, void>DiscardView1_134;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, uint, win32.Graphics.Direct3D11.D3D11_TILED_RESOURCE_COORDINATE*, win32.Graphics.Direct3D11.D3D11_TILE_REGION_SIZE*, win32.Graphics.Direct3D11.ID3D11Buffer*, uint, uint *, uint *, uint *, uint, win32.System.Com.HRESULT>UpdateTileMappings_135;
                ...
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_TILED_RESOURCE_COORDINATE*, win32.Graphics.Direct3D11.D3D11_TILE_REGION_SIZE*, win32.Graphics.Direct3D11.ID3D11Buffer*, ulong, uint, void>CopyTiles_137;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Resource*, win32.Graphics.Direct3D11.D3D11_TILED_RESOURCE_COORDINATE*, win32.Graphics.Direct3D11.D3D11_TILE_REGION_SIZE*, void *, uint, void>UpdateTiles_138;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11Buffer*, ulong, win32.System.Com.HRESULT>ResizeTilePool_139;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.ID3D11DeviceChild*, win32.Graphics.Direct3D11.ID3D11DeviceChild*, void>TiledResourceBarrier_140;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.System.SystemServices.BOOL>IsAnnotationEnabled_141;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.System.SystemServices.PCWSTR, int, void>SetMarkerInt_142;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.System.SystemServices.PCWSTR, int, void>BeginEventInt_143;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, void>EndEvent_144;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.Graphics.Direct3D11.D3D11_CONTEXT_TYPE, win32.System.SystemServices.HANDLE, void>Flush1_145;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.System.SystemServices.BOOL, void>SetHardwareProtectionState_146;
                internal delegate *unmanaged[Stdcall]<ID3D11DeviceContext3*, win32.System.SystemServices.BOOL*, void>GetHardwareProtectionState_147;
            }
