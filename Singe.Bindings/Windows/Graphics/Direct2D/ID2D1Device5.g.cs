...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct2D
    {
        ...
        internal unsafe struct ID2D1Device5
        {
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_3/nf-d2d1_3-id2d1device5-createdevicecontext#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_3/nf-d2d1_3-id2d1device5-createdevicecontext">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.ID2D1Factory**, void>GetFactory_4;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, win32.Graphics.Direct2D.ID2D1DeviceContext**, win32.System.Com.HRESULT>CreateDeviceContext_5;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Imaging.IWICImagingFactory*, win32.Storage.Xps.IPrintDocumentPackageTarget*, win32.Graphics.Direct2D.D2D1_PRINT_CONTROL_PROPERTIES*, win32.Graphics.Direct2D.ID2D1PrintControl**, win32.System.Com.HRESULT>CreatePrintControl_6;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, ulong, void>SetMaximumTextureMemory_7;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, ulong>GetMaximumTextureMemory_8;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, uint, void>ClearResources_9;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.D2D1_RENDERING_PRIORITY>GetRenderingPriority_10;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.D2D1_RENDERING_PRIORITY, void>SetRenderingPriority_11;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, win32.Graphics.Direct2D.ID2D1DeviceContext1**, win32.System.Com.HRESULT>CreateDeviceContext_12;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, win32.Graphics.Direct2D.ID2D1DeviceContext2**, win32.System.Com.HRESULT>CreateDeviceContext_13;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.ID2D1Bitmap*, void>FlushDeviceContexts_14;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Dxgi.IDXGIDevice**, win32.System.Com.HRESULT>GetDxgiDevice_15;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, win32.Graphics.Direct2D.ID2D1DeviceContext3**, win32.System.Com.HRESULT>CreateDeviceContext_16;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, win32.Graphics.Direct2D.ID2D1DeviceContext4**, win32.System.Com.HRESULT>CreateDeviceContext_17;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, ulong, void>SetMaximumColorGlyphCacheMemory_18;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, ulong>GetMaximumColorGlyphCacheMemory_19;
                internal delegate *unmanaged[Stdcall]<ID2D1Device5*, win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, win32.Graphics.Direct2D.ID2D1DeviceContext5**, win32.System.Com.HRESULT>CreateDeviceContext_20;
            }
