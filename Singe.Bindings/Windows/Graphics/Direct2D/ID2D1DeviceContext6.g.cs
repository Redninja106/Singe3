...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct2D
    {
        ...
        internal unsafe struct ID2D1DeviceContext6
        {
            ...
            {
                fixed (ID2D1DeviceContext6*pThis = &this)
            ...
            internal unsafe win32.System.Com.HRESULT CreateSvgDocument([Optional] win32.Storage.StructuredStorage.IStream*inputXmlStream, win32.Graphics.Direct2D.D2D_SIZE_F viewportSize, win32.Graphics.Direct2D.ID2D1SvgDocument**svgDocument)
            {
                fixed (ID2D1DeviceContext6*pThis = &this)
                    return lpVtbl->CreateSvgDocument_116(pThis, inputXmlStream, viewportSize, svgDocument);
            }

            internal unsafe void DrawSvgDocument(win32.Graphics.Direct2D.ID2D1SvgDocument*svgDocument)
            {
                fixed (ID2D1DeviceContext6*pThis = &this)
                    lpVtbl->DrawSvgDocument_117(pThis, svgDocument);
            }
            ...
            {
                fixed (ID2D1DeviceContext6*pThis = &this)
                    return lpVtbl->CreateColorContextFromDxgiColorSpace_118(pThis, colorSpace, colorContext);
            }
            ...
            {
                fixed (ID2D1DeviceContext6*pThis = &this)
                    return lpVtbl->CreateColorContextFromSimpleColorProfile_119(pThis, simpleProfile, colorContext);
            }
            ...
            internal unsafe void BlendImage(win32.Graphics.Direct2D.ID2D1Image*image, win32.Graphics.Direct2D.D2D1_BLEND_MODE blendMode, win32.Graphics.Direct2D.D2D_POINT_2F? targetOffset, win32.Graphics.Direct2D.D2D_RECT_F? imageRectangle, win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE interpolationMode)
            {
                win32.Graphics.Direct2D.D2D_POINT_2F targetOffsetLocal = targetOffset.HasValue ? targetOffset.Value : default(win32.Graphics.Direct2D.D2D_POINT_2F);
                win32.Graphics.Direct2D.D2D_RECT_F imageRectangleLocal = imageRectangle.HasValue ? imageRectangle.Value : default(win32.Graphics.Direct2D.D2D_RECT_F);
            ...
            /// </remarks>
            internal unsafe void BlendImage(win32.Graphics.Direct2D.ID2D1Image*image, win32.Graphics.Direct2D.D2D1_BLEND_MODE blendMode, [Optional] win32.Graphics.Direct2D.D2D_POINT_2F*targetOffset, [Optional] win32.Graphics.Direct2D.D2D_RECT_F*imageRectangle, win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE interpolationMode)
            {
                fixed (ID2D1DeviceContext6*pThis = &this)
                    lpVtbl->BlendImage_120(pThis, image, blendMode, targetOffset, imageRectangle, interpolationMode);
            }

            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Factory**, void>GetFactory_4;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_SIZE_U, void *, uint, win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES*, win32.Graphics.Direct2D.ID2D1Bitmap**, win32.System.Com.HRESULT>CreateBitmap_5;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Imaging.IWICBitmapSource*, win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES*, win32.Graphics.Direct2D.ID2D1Bitmap**, win32.System.Com.HRESULT>CreateBitmapFromWicBitmap_6;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, global::System.Guid*, void *, win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES*, win32.Graphics.Direct2D.ID2D1Bitmap**, win32.System.Com.HRESULT>CreateSharedBitmap_7;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.D2D1_BITMAP_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.ID2D1BitmapBrush**, win32.System.Com.HRESULT>CreateBitmapBrush_8;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_COLOR_F*, win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.ID2D1SolidColorBrush**, win32.System.Com.HRESULT>CreateSolidColorBrush_9;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_GRADIENT_STOP*, uint, win32.Graphics.Direct2D.D2D1_GAMMA, win32.Graphics.Direct2D.D2D1_EXTEND_MODE, win32.Graphics.Direct2D.ID2D1GradientStopCollection**, win32.System.Com.HRESULT>CreateGradientStopCollection_10;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.ID2D1GradientStopCollection*, win32.Graphics.Direct2D.ID2D1LinearGradientBrush**, win32.System.Com.HRESULT>CreateLinearGradientBrush_11;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.ID2D1GradientStopCollection*, win32.Graphics.Direct2D.ID2D1RadialGradientBrush**, win32.System.Com.HRESULT>CreateRadialGradientBrush_12;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_SIZE_F*, win32.Graphics.Direct2D.D2D_SIZE_U*, win32.Graphics.Direct2D.D2D1_PIXEL_FORMAT*, win32.Graphics.Direct2D.D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS, win32.Graphics.Direct2D.ID2D1BitmapRenderTarget**, win32.System.Com.HRESULT>CreateCompatibleRenderTarget_13;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_SIZE_F*, win32.Graphics.Direct2D.ID2D1Layer**, win32.System.Com.HRESULT>CreateLayer_14;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Mesh**, win32.System.Com.HRESULT>CreateMesh_15;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.Direct2D.ID2D1Brush*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, void>DrawLine_16;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.ID2D1Brush*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, void>DrawRectangle_17;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.ID2D1Brush*, void>FillRectangle_18;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_ROUNDED_RECT*, win32.Graphics.Direct2D.ID2D1Brush*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, void>DrawRoundedRectangle_19;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_ROUNDED_RECT*, win32.Graphics.Direct2D.ID2D1Brush*, void>FillRoundedRectangle_20;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_ELLIPSE*, win32.Graphics.Direct2D.ID2D1Brush*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, void>DrawEllipse_21;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_ELLIPSE*, win32.Graphics.Direct2D.ID2D1Brush*, void>FillEllipse_22;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.ID2D1Brush*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, void>DrawGeometry_23;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.ID2D1Brush*, void>FillGeometry_24;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Mesh*, win32.Graphics.Direct2D.ID2D1Brush*, void>FillMesh_25;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.D2D1_OPACITY_MASK_CONTENT, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D_RECT_F*, void>FillOpacityMask_26;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.D2D_RECT_F*, float, win32.Graphics.Direct2D.D2D1_BITMAP_INTERPOLATION_MODE, win32.Graphics.Direct2D.D2D_RECT_F*, void>DrawBitmap_27;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.System.SystemServices.PCWSTR, uint, win32.Graphics.DirectWrite.IDWriteTextFormat*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.D2D1_DRAW_TEXT_OPTIONS, win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, void>DrawText_28;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.IDWriteTextLayout*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.D2D1_DRAW_TEXT_OPTIONS, void>DrawTextLayout_29;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, void>DrawGlyphRun_30;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, void>SetTransform_31;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, void>GetTransform_32;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_ANTIALIAS_MODE, void>SetAntialiasMode_33;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_ANTIALIAS_MODE>GetAntialiasMode_34;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_TEXT_ANTIALIAS_MODE, void>SetTextAntialiasMode_35;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_TEXT_ANTIALIAS_MODE>GetTextAntialiasMode_36;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.DirectWrite.IDWriteRenderingParams*, void>SetTextRenderingParams_37;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.DirectWrite.IDWriteRenderingParams**, void>GetTextRenderingParams_38;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, ulong, ulong, void>SetTags_39;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, ulong *, ulong *, void>GetTags_40;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_LAYER_PARAMETERS*, win32.Graphics.Direct2D.ID2D1Layer*, void>PushLayer_41;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, void>PopLayer_42;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, ulong *, ulong *, win32.System.Com.HRESULT>Flush_43;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1DrawingStateBlock*, void>SaveDrawingState_44;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1DrawingStateBlock*, void>RestoreDrawingState_45;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D1_ANTIALIAS_MODE, void>PushAxisAlignedClip_46;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, void>PopAxisAlignedClip_47;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_COLOR_F*, void>Clear_48;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, void>BeginDraw_49;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, ulong *, ulong *, win32.System.Com.HRESULT>EndDraw_50;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_PIXEL_FORMAT>GetPixelFormat_51;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, float, float, void>SetDpi_52;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, float *, float *, void>GetDpi_53;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_SIZE_F>GetSize_54;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_SIZE_U>GetPixelSize_55;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, uint>GetMaximumBitmapSize_56;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.System.SystemServices.BOOL>IsSupported_57;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_SIZE_U, void *, uint, win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES1*, win32.Graphics.Direct2D.ID2D1Bitmap1**, win32.System.Com.HRESULT>CreateBitmap_58;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Imaging.IWICBitmapSource*, win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES1*, win32.Graphics.Direct2D.ID2D1Bitmap1**, win32.System.Com.HRESULT>CreateBitmapFromWicBitmap_59;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_COLOR_SPACE, byte *, uint, win32.Graphics.Direct2D.ID2D1ColorContext**, win32.System.Com.HRESULT>CreateColorContext_60;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.System.SystemServices.PCWSTR, win32.Graphics.Direct2D.ID2D1ColorContext**, win32.System.Com.HRESULT>CreateColorContextFromFilename_61;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Imaging.IWICColorContext*, win32.Graphics.Direct2D.ID2D1ColorContext**, win32.System.Com.HRESULT>CreateColorContextFromWicColorContext_62;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Dxgi.IDXGISurface*, win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES1*, win32.Graphics.Direct2D.ID2D1Bitmap1**, win32.System.Com.HRESULT>CreateBitmapFromDxgiSurface_63;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, global::System.Guid*, win32.Graphics.Direct2D.ID2D1Effect**, win32.System.Com.HRESULT>CreateEffect_64;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_GRADIENT_STOP*, uint, win32.Graphics.Direct2D.D2D1_COLOR_SPACE, win32.Graphics.Direct2D.D2D1_COLOR_SPACE, win32.Graphics.Direct2D.D2D1_BUFFER_PRECISION, win32.Graphics.Direct2D.D2D1_EXTEND_MODE, win32.Graphics.Direct2D.D2D1_COLOR_INTERPOLATION_MODE, win32.Graphics.Direct2D.ID2D1GradientStopCollection1**, win32.System.Com.HRESULT>CreateGradientStopCollection_65;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Image*, win32.Graphics.Direct2D.D2D1_IMAGE_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.ID2D1ImageBrush**, win32.System.Com.HRESULT>CreateImageBrush_66;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.D2D1_BITMAP_BRUSH_PROPERTIES1*, win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES*, win32.Graphics.Direct2D.ID2D1BitmapBrush1**, win32.System.Com.HRESULT>CreateBitmapBrush_67;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1CommandList**, win32.System.Com.HRESULT>CreateCommandList_68;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Dxgi.DXGI_FORMAT, win32.System.SystemServices.BOOL>IsDxgiFormatSupported_69;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_BUFFER_PRECISION, win32.System.SystemServices.BOOL>IsBufferPrecisionSupported_70;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Image*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>GetImageLocalBounds_71;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Image*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>GetImageWorldBounds_72;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN*, win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>GetGlyphRunWorldBounds_73;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Device**, void>GetDevice_74;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Image*, void>SetTarget_75;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Image**, void>GetTarget_76;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_RENDERING_CONTROLS*, void>SetRenderingControls_77;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_RENDERING_CONTROLS*, void>GetRenderingControls_78;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_PRIMITIVE_BLEND, void>SetPrimitiveBlend_79;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_PRIMITIVE_BLEND>GetPrimitiveBlend_80;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_UNIT_MODE, void>SetUnitMode_81;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_UNIT_MODE>GetUnitMode_82;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN*, win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_DESCRIPTION*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, void>DrawGlyphRun_83;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Image*, win32.Graphics.Direct2D.D2D_POINT_2F*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, win32.Graphics.Direct2D.D2D1_COMPOSITE_MODE, void>DrawImage_84;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1GdiMetafile*, win32.Graphics.Direct2D.D2D_POINT_2F*, void>DrawGdiMetafile_85;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.D2D_RECT_F*, float, win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D_MATRIX_4X4_F*, void>DrawBitmap_86;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_LAYER_PARAMETERS1*, win32.Graphics.Direct2D.ID2D1Layer*, void>PushLayer_87;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Effect*, uint, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>InvalidateEffectInputRectangle_88;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Effect*, uint *, win32.System.Com.HRESULT>GetEffectInvalidRectangleCount_89;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Effect*, win32.Graphics.Direct2D.D2D_RECT_F*, uint, win32.System.Com.HRESULT>GetEffectInvalidRectangles_90;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Effect*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D1_EFFECT_INPUT_DESCRIPTION*, win32.Graphics.Direct2D.D2D_RECT_F*, uint, win32.System.Com.HRESULT>GetEffectRequiredInputRectangles_91;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D_RECT_F*, void>FillOpacityMask_92;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Geometry*, float, win32.Graphics.Direct2D.ID2D1GeometryRealization**, win32.System.Com.HRESULT>CreateFilledGeometryRealization_93;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Geometry*, float, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.Graphics.Direct2D.ID2D1GeometryRealization**, win32.System.Com.HRESULT>CreateStrokedGeometryRealization_94;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1GeometryRealization*, win32.Graphics.Direct2D.ID2D1Brush*, void>DrawGeometryRealization_95;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_INK_POINT*, win32.Graphics.Direct2D.ID2D1Ink**, win32.System.Com.HRESULT>CreateInk_96;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_INK_STYLE_PROPERTIES*, win32.Graphics.Direct2D.ID2D1InkStyle**, win32.System.Com.HRESULT>CreateInkStyle_97;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_GRADIENT_MESH_PATCH*, uint, win32.Graphics.Direct2D.ID2D1GradientMesh**, win32.System.Com.HRESULT>CreateGradientMesh_98;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Imaging.IWICBitmapSource*, win32.Graphics.Direct2D.D2D1_IMAGE_SOURCE_LOADING_OPTIONS, win32.Graphics.Direct2D.D2D1_ALPHA_MODE, win32.Graphics.Direct2D.ID2D1ImageSourceFromWic**, win32.System.Com.HRESULT>CreateImageSourceFromWic_99;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_BUFFER_PRECISION, uint *, byte *, uint, uint *, win32.Graphics.Direct2D.ID2D1LookupTable3D**, win32.System.Com.HRESULT>CreateLookupTable3D_100;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Dxgi.IDXGISurface**, uint, win32.Graphics.Dxgi.DXGI_COLOR_SPACE_TYPE, win32.Graphics.Direct2D.D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS, win32.Graphics.Direct2D.ID2D1ImageSource**, win32.System.Com.HRESULT>CreateImageSourceFromDxgi_101;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1GradientMesh*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>GetGradientMeshWorldBounds_102;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Ink*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.ID2D1InkStyle*, void>DrawInk_103;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1GradientMesh*, void>DrawGradientMesh_104;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1GdiMetafile*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D_RECT_F*, void>DrawGdiMetafile_105;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1ImageSource*, win32.Graphics.Direct2D.D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES*, win32.Graphics.Direct2D.ID2D1TransformedImageSource**, win32.System.Com.HRESULT>CreateTransformedImageSource_106;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1SpriteBatch**, win32.System.Com.HRESULT>CreateSpriteBatch_107;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1SpriteBatch*, uint, uint, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.D2D1_BITMAP_INTERPOLATION_MODE, win32.Graphics.Direct2D.D2D1_SPRITE_OPTIONS, void>DrawSpriteBatch_108;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1SvgGlyphStyle**, win32.System.Com.HRESULT>CreateSvgGlyphStyle_109;
                ...
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.IDWriteTextLayout*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.ID2D1SvgGlyphStyle*, uint, win32.Graphics.Direct2D.D2D1_DRAW_TEXT_OPTIONS, void>DrawTextLayout_111;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_FORMATS, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN*, win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, win32.Graphics.Direct2D.D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION, void>DrawColorBitmapGlyphRun_112;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.ID2D1SvgGlyphStyle*, uint, win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, void>DrawSvgGlyphRun_113;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_FORMATS, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.IDWriteFontFace*, float, ushort, win32.System.SystemServices.BOOL, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, float, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, win32.Graphics.Direct2D.ID2D1Image**, win32.System.Com.HRESULT>GetColorBitmapGlyphImage_114;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.IDWriteFontFace*, float, ushort, win32.System.SystemServices.BOOL, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.ID2D1SvgGlyphStyle*, uint, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, win32.Graphics.Direct2D.ID2D1CommandList**, win32.System.Com.HRESULT>GetSvgGlyphImage_115;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Storage.StructuredStorage.IStream*, win32.Graphics.Direct2D.D2D_SIZE_F, win32.Graphics.Direct2D.ID2D1SvgDocument**, win32.System.Com.HRESULT>CreateSvgDocument_116;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1SvgDocument*, void>DrawSvgDocument_117;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Dxgi.DXGI_COLOR_SPACE_TYPE, win32.Graphics.Direct2D.ID2D1ColorContext1**, win32.System.Com.HRESULT>CreateColorContextFromDxgiColorSpace_118;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.D2D1_SIMPLE_COLOR_PROFILE*, win32.Graphics.Direct2D.ID2D1ColorContext1**, win32.System.Com.HRESULT>CreateColorContextFromSimpleColorProfile_119;
                internal delegate *unmanaged[Stdcall]<ID2D1DeviceContext6*, win32.Graphics.Direct2D.ID2D1Image*, win32.Graphics.Direct2D.D2D1_BLEND_MODE, win32.Graphics.Direct2D.D2D_POINT_2F*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, void>BlendImage_120;
            }
