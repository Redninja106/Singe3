...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct2D
    {
        ...
        internal unsafe struct ID2D1RectangleGeometry
        {
            ...
            {
                fixed (ID2D1RectangleGeometry*pThis = &this)
            ...
            /// <inheritdoc cref = "GetRect(win32.Graphics.Direct2D.D2D_RECT_F*)"/>
            internal unsafe void GetRect(out win32.Graphics.Direct2D.D2D_RECT_F rect)
            {
                fixed (win32.Graphics.Direct2D.D2D_RECT_F*rectLocal = &rect)
                {
                    this.GetRect(rectLocal);
                }
            }
            ...
            /// <para>Contains a pointer to a rectangle that describes the rectangle geometry's dimensions when this method returns. You must allocate storage for this parameter.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1/nf-d2d1-id2d1rectanglegeometry-getrect#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1/nf-d2d1-id2d1rectanglegeometry-getrect">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            internal unsafe void GetRect(win32.Graphics.Direct2D.D2D_RECT_F*rect)
            {
                fixed (ID2D1RectangleGeometry*pThis = &this)
                    lpVtbl->GetRect_18(pThis, rect);
            }

            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.ID2D1Factory**, void>GetFactory_4;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>GetBounds_5;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>GetWidenedBounds_6;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D_POINT_2F, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.System.SystemServices.BOOL*, win32.System.Com.HRESULT>StrokeContainsPoint_7;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.System.SystemServices.BOOL*, win32.System.Com.HRESULT>FillContainsPoint_8;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.D2D1_GEOMETRY_RELATION*, win32.System.Com.HRESULT>CompareWithGeometry_9;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D1_GEOMETRY_SIMPLIFICATION_OPTION, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1SimplifiedGeometrySink*, win32.System.Com.HRESULT>Simplify_10;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1TessellationSink*, win32.System.Com.HRESULT>Tessellate_11;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.D2D1_COMBINE_MODE, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1SimplifiedGeometrySink*, win32.System.Com.HRESULT>CombineWithGeometry_12;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1SimplifiedGeometrySink*, win32.System.Com.HRESULT>Outline_13;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, float *, win32.System.Com.HRESULT>ComputeArea_14;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, float *, win32.System.Com.HRESULT>ComputeLength_15;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, float, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.D2D_POINT_2F*, win32.Graphics.Direct2D.D2D_POINT_2F*, win32.System.Com.HRESULT>ComputePointAtLength_16;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1SimplifiedGeometrySink*, win32.System.Com.HRESULT>Widen_17;
                internal delegate *unmanaged[Stdcall]<ID2D1RectangleGeometry*, win32.Graphics.Direct2D.D2D_RECT_F*, void>GetRect_18;
            }
