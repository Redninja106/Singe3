...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct2D
    {
        ...
        internal unsafe struct ID2D1Factory1
        {
            ...
            {
                fixed (ID2D1Factory1*pThis = &this)
            ...
            /// <summary>Creates an ID2D1PathGeometry1 object.</summary>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-createpathgeometry#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-createpathgeometry">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <summary>Creates a ID2D1Device object.</summary>
            ...
            /// <para>The <a href = "https://docs.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgidevice">IDXGIDevice</a> object used when creating  the <a href = "https://docs.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1device">ID2D1Device</a>.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-createdevice#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            ...
            /// <para>The requested <a href = "https://docs.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1device">ID2D1Device</a> object.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-createdevice#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-createdevice">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <summary>Creates a new ID2D1GdiMetafile object that you can use to replay metafile content.</summary>
            /// <param name = "metafileStream">
            /// <para>Type: <b>IStream*</b></para>
            /// <para>A stream object that has the metafile data.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-creategdimetafile#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "metafile">
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-creategdimetafile">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-registereffectfromstream#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            ...
            /// </param>
            /// <param name = "bindings">
            /// <para>Type: <b>const <a href = "https://docs.microsoft.com/windows/desktop/api/d2d1effectauthor/ns-d2d1effectauthor-d2d1_property_binding">D2D1_PROPERTY_BINDING</a>*</b></para>
            /// <para>An array of properties and methods.</para>
            /// <para>This binds a property by name to a particular method implemented by the effect author to handle the property. The name must be found in the corresponding <i>propertyXml</i>.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-registereffectfromstream#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "bindingsCount">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/webservices/ns-webservices-ws_uint32_description">UINT32</a></b></para>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-registereffectfromstream">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para>Type: <b>REFCLSID</b></para>
            /// <para>The identifier of the effect to be registered.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-registereffectfromstring#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "propertyXml">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/chstring/nf-chstring-chstring-chstring(lpcwstr)">PCWSTR</a></b></para>
            /// <para>A list of the effect properties, types, and metadata.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-registereffectfromstring#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "bindings">
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-registereffectfromstring">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <summary>Unregisters an effect within the factory instance that corresponds to the classId provided.</summary>
            /// <param name = "classId">
            /// <para>Type: <b>REFCLSID</b></para>
            /// <para>The identifier of the effect to be unregistered.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-unregistereffect#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b></para>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-unregistereffect">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-getregisteredeffects#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-getregisteredeffects">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-geteffectproperties#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name = "properties">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1properties">ID2D1Properties</a>**</b></para>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_1/nf-d2d1_1-id2d1factory1-geteffectproperties">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.System.Com.HRESULT>ReloadSystemMetrics_4;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, float *, float *, void>GetDesktopDpi_5;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.ID2D1RectangleGeometry**, win32.System.Com.HRESULT>CreateRectangleGeometry_6;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_ROUNDED_RECT*, win32.Graphics.Direct2D.ID2D1RoundedRectangleGeometry**, win32.System.Com.HRESULT>CreateRoundedRectangleGeometry_7;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_ELLIPSE*, win32.Graphics.Direct2D.ID2D1EllipseGeometry**, win32.System.Com.HRESULT>CreateEllipseGeometry_8;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_FILL_MODE, win32.Graphics.Direct2D.ID2D1Geometry**, uint, win32.Graphics.Direct2D.ID2D1GeometryGroup**, win32.System.Com.HRESULT>CreateGeometryGroup_9;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, win32.Graphics.Direct2D.ID2D1TransformedGeometry**, win32.System.Com.HRESULT>CreateTransformedGeometry_10;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.ID2D1PathGeometry**, win32.System.Com.HRESULT>CreatePathGeometry_11;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_STROKE_STYLE_PROPERTIES*, float *, uint, win32.Graphics.Direct2D.ID2D1StrokeStyle**, win32.System.Com.HRESULT>CreateStrokeStyle_12;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION*, win32.Graphics.DirectWrite.IDWriteRenderingParams*, win32.Graphics.Direct2D.ID2D1DrawingStateBlock**, win32.System.Com.HRESULT>CreateDrawingStateBlock_13;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Imaging.IWICBitmap*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.ID2D1RenderTarget**, win32.System.Com.HRESULT>CreateWicBitmapRenderTarget_14;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.D2D1_HWND_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.ID2D1HwndRenderTarget**, win32.System.Com.HRESULT>CreateHwndRenderTarget_15;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Dxgi.IDXGISurface*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.ID2D1RenderTarget**, win32.System.Com.HRESULT>CreateDxgiSurfaceRenderTarget_16;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.ID2D1DCRenderTarget**, win32.System.Com.HRESULT>CreateDCRenderTarget_17;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Dxgi.IDXGIDevice*, win32.Graphics.Direct2D.ID2D1Device**, win32.System.Com.HRESULT>CreateDevice_18;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_STROKE_STYLE_PROPERTIES1*, float *, uint, win32.Graphics.Direct2D.ID2D1StrokeStyle1**, win32.System.Com.HRESULT>CreateStrokeStyle_19;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.ID2D1PathGeometry1**, win32.System.Com.HRESULT>CreatePathGeometry_20;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION1*, win32.Graphics.DirectWrite.IDWriteRenderingParams*, win32.Graphics.Direct2D.ID2D1DrawingStateBlock1**, win32.System.Com.HRESULT>CreateDrawingStateBlock_21;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, win32.Storage.StructuredStorage.IStream*, win32.Graphics.Direct2D.ID2D1GdiMetafile**, win32.System.Com.HRESULT>CreateGdiMetafile_22;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, global::System.Guid*, win32.Storage.StructuredStorage.IStream*, win32.Graphics.Direct2D.D2D1_PROPERTY_BINDING*, uint, delegate *unmanaged[Stdcall]<win32.System.Com.IUnknown**, win32.System.Com.HRESULT>, win32.System.Com.HRESULT>RegisterEffectFromStream_23;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, global::System.Guid*, win32.System.SystemServices.PCWSTR, win32.Graphics.Direct2D.D2D1_PROPERTY_BINDING*, uint, delegate *unmanaged[Stdcall]<win32.System.Com.IUnknown**, win32.System.Com.HRESULT>, win32.System.Com.HRESULT>RegisterEffectFromString_24;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, global::System.Guid*, win32.System.Com.HRESULT>UnregisterEffect_25;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, global::System.Guid*, uint, uint *, uint *, win32.System.Com.HRESULT>GetRegisteredEffects_26;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory1*, global::System.Guid*, win32.Graphics.Direct2D.ID2D1Properties**, win32.System.Com.HRESULT>GetEffectProperties_27;
            }
