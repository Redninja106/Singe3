...
namespace Windows.Win32
{
    ...
    {
        /// <summary>The interpolation mode the Point-diffuse lighting effect uses to scale the image to the corresponding kernel unit length. There are six scale modes that range in quality and speed.</summary>
        /// <remarks>
        /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1effects/ne-d2d1effects-d2d1_pointdiffuse_scale_mode">Learn more about this API from docs.microsoft.com</see>.</para>
        /// </remarks>
        internal enum D2D1_POINTDIFFUSE_SCALE_MODE : uint
        {
            ...
            D2D1_POINTDIFFUSE_SCALE_MODE_NEAREST_NEIGHBOR = 0U,
            ...
            D2D1_POINTDIFFUSE_SCALE_MODE_LINEAR = 1U,
            ...
            D2D1_POINTDIFFUSE_SCALE_MODE_CUBIC = 2U,
            ...
            D2D1_POINTDIFFUSE_SCALE_MODE_HIGH_QUALITY_CUBIC = 5U,
            /// <summary></summary>
            D2D1_POINTDIFFUSE_SCALE_MODE_FORCE_DWORD = 4294967295U,
        }
    }
}