...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct2D
    {
        ...
        internal unsafe struct ID2D1Factory6
        {
            ...
            {
                fixed (ID2D1Factory6*pThis = &this)
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_3/nf-d2d1_3-id2d1factory6-createdevice#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_3/nf-d2d1_3-id2d1factory6-createdevice">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.System.Com.HRESULT>ReloadSystemMetrics_4;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, float *, float *, void>GetDesktopDpi_5;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.ID2D1RectangleGeometry**, win32.System.Com.HRESULT>CreateRectangleGeometry_6;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_ROUNDED_RECT*, win32.Graphics.Direct2D.ID2D1RoundedRectangleGeometry**, win32.System.Com.HRESULT>CreateRoundedRectangleGeometry_7;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_ELLIPSE*, win32.Graphics.Direct2D.ID2D1EllipseGeometry**, win32.System.Com.HRESULT>CreateEllipseGeometry_8;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_FILL_MODE, win32.Graphics.Direct2D.ID2D1Geometry**, uint, win32.Graphics.Direct2D.ID2D1GeometryGroup**, win32.System.Com.HRESULT>CreateGeometryGroup_9;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, win32.Graphics.Direct2D.ID2D1TransformedGeometry**, win32.System.Com.HRESULT>CreateTransformedGeometry_10;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.ID2D1PathGeometry**, win32.System.Com.HRESULT>CreatePathGeometry_11;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_STROKE_STYLE_PROPERTIES*, float *, uint, win32.Graphics.Direct2D.ID2D1StrokeStyle**, win32.System.Com.HRESULT>CreateStrokeStyle_12;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION*, win32.Graphics.DirectWrite.IDWriteRenderingParams*, win32.Graphics.Direct2D.ID2D1DrawingStateBlock**, win32.System.Com.HRESULT>CreateDrawingStateBlock_13;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Imaging.IWICBitmap*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.ID2D1RenderTarget**, win32.System.Com.HRESULT>CreateWicBitmapRenderTarget_14;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.D2D1_HWND_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.ID2D1HwndRenderTarget**, win32.System.Com.HRESULT>CreateHwndRenderTarget_15;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Dxgi.IDXGISurface*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.ID2D1RenderTarget**, win32.System.Com.HRESULT>CreateDxgiSurfaceRenderTarget_16;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES*, win32.Graphics.Direct2D.ID2D1DCRenderTarget**, win32.System.Com.HRESULT>CreateDCRenderTarget_17;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Dxgi.IDXGIDevice*, win32.Graphics.Direct2D.ID2D1Device**, win32.System.Com.HRESULT>CreateDevice_18;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_STROKE_STYLE_PROPERTIES1*, float *, uint, win32.Graphics.Direct2D.ID2D1StrokeStyle1**, win32.System.Com.HRESULT>CreateStrokeStyle_19;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.ID2D1PathGeometry1**, win32.System.Com.HRESULT>CreatePathGeometry_20;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION1*, win32.Graphics.DirectWrite.IDWriteRenderingParams*, win32.Graphics.Direct2D.ID2D1DrawingStateBlock1**, win32.System.Com.HRESULT>CreateDrawingStateBlock_21;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Storage.StructuredStorage.IStream*, win32.Graphics.Direct2D.ID2D1GdiMetafile**, win32.System.Com.HRESULT>CreateGdiMetafile_22;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, global::System.Guid*, win32.Storage.StructuredStorage.IStream*, win32.Graphics.Direct2D.D2D1_PROPERTY_BINDING*, uint, delegate *unmanaged[Stdcall]<win32.System.Com.IUnknown**, win32.System.Com.HRESULT>, win32.System.Com.HRESULT>RegisterEffectFromStream_23;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, global::System.Guid*, win32.System.SystemServices.PCWSTR, win32.Graphics.Direct2D.D2D1_PROPERTY_BINDING*, uint, delegate *unmanaged[Stdcall]<win32.System.Com.IUnknown**, win32.System.Com.HRESULT>, win32.System.Com.HRESULT>RegisterEffectFromString_24;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, global::System.Guid*, win32.System.Com.HRESULT>UnregisterEffect_25;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, global::System.Guid*, uint, uint *, uint *, win32.System.Com.HRESULT>GetRegisteredEffects_26;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, global::System.Guid*, win32.Graphics.Direct2D.ID2D1Properties**, win32.System.Com.HRESULT>GetEffectProperties_27;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Dxgi.IDXGIDevice*, win32.Graphics.Direct2D.ID2D1Device1**, win32.System.Com.HRESULT>CreateDevice_28;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Dxgi.IDXGIDevice*, win32.Graphics.Direct2D.ID2D1Device2**, win32.System.Com.HRESULT>CreateDevice_29;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Dxgi.IDXGIDevice*, win32.Graphics.Direct2D.ID2D1Device3**, win32.System.Com.HRESULT>CreateDevice_30;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Dxgi.IDXGIDevice*, win32.Graphics.Direct2D.ID2D1Device4**, win32.System.Com.HRESULT>CreateDevice_31;
                internal delegate *unmanaged[Stdcall]<ID2D1Factory6*, win32.Graphics.Dxgi.IDXGIDevice*, win32.Graphics.Direct2D.ID2D1Device5**, win32.System.Com.HRESULT>CreateDevice_32;
            }
