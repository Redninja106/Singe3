...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct2D
    {
        ...
        internal unsafe struct ID2D1RoundedRectangleGeometry
        {
            ...
            {
                fixed (ID2D1RoundedRectangleGeometry*pThis = &this)
            ...
            /// <inheritdoc cref = "GetRoundedRect(win32.Graphics.Direct2D.D2D1_ROUNDED_RECT*)"/>
            internal unsafe void GetRoundedRect(out win32.Graphics.Direct2D.D2D1_ROUNDED_RECT roundedRect)
            {
                fixed (win32.Graphics.Direct2D.D2D1_ROUNDED_RECT*roundedRectLocal = &roundedRect)
                {
                    this.GetRoundedRect(roundedRectLocal);
                }
            }

            /// <summary>Retrieves a rounded rectangle that describes this rounded rectangle geometry.</summary>
            /// <param name = "roundedRect">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/win32/api/d2d1/ns-d2d1-d2d1_rounded_rect">D2D1_ROUNDED_RECT</a>*</b></para>
            /// <para>A pointer that receives a rounded rectangle that describes this rounded rectangle geometry. You must allocate storage for this parameter.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1/nf-d2d1-id2d1roundedrectanglegeometry-getroundedrect#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1/nf-d2d1-id2d1roundedrectanglegeometry-getroundedrect">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            internal unsafe void GetRoundedRect(win32.Graphics.Direct2D.D2D1_ROUNDED_RECT*roundedRect)
            {
                fixed (ID2D1RoundedRectangleGeometry*pThis = &this)
                    lpVtbl->GetRoundedRect_18(pThis, roundedRect);
            }

            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.ID2D1Factory**, void>GetFactory_4;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>GetBounds_5;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>GetWidenedBounds_6;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D_POINT_2F, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.System.SystemServices.BOOL*, win32.System.Com.HRESULT>StrokeContainsPoint_7;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.System.SystemServices.BOOL*, win32.System.Com.HRESULT>FillContainsPoint_8;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.D2D1_GEOMETRY_RELATION*, win32.System.Com.HRESULT>CompareWithGeometry_9;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D1_GEOMETRY_SIMPLIFICATION_OPTION, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1SimplifiedGeometrySink*, win32.System.Com.HRESULT>Simplify_10;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1TessellationSink*, win32.System.Com.HRESULT>Tessellate_11;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.D2D1_COMBINE_MODE, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1SimplifiedGeometrySink*, win32.System.Com.HRESULT>CombineWithGeometry_12;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1SimplifiedGeometrySink*, win32.System.Com.HRESULT>Outline_13;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, float *, win32.System.Com.HRESULT>ComputeArea_14;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, float *, win32.System.Com.HRESULT>ComputeLength_15;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, float, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.D2D_POINT_2F*, win32.Graphics.Direct2D.D2D_POINT_2F*, win32.System.Com.HRESULT>ComputePointAtLength_16;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, float, win32.Graphics.Direct2D.ID2D1SimplifiedGeometrySink*, win32.System.Com.HRESULT>Widen_17;
                internal delegate *unmanaged[Stdcall]<ID2D1RoundedRectangleGeometry*, win32.Graphics.Direct2D.D2D1_ROUNDED_RECT*, void>GetRoundedRect_18;
            }
