...
namespace Windows.Win32
{
    ...
    {
        /// <summary>The interpolation mode the 3D transform effect uses on the image. There are 5 scale modes that range in quality and speed.</summary>
        /// <remarks>
        /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1effects/ne-d2d1effects-d2d1_3dtransform_interpolation_mode">Learn more about this API from docs.microsoft.com</see>.</para>
        /// </remarks>
        internal enum D2D1_3DTRANSFORM_INTERPOLATION_MODE : uint
        {
            ...
            D2D1_3DTRANSFORM_INTERPOLATION_MODE_NEAREST_NEIGHBOR = 0U,
            ...
            D2D1_3DTRANSFORM_INTERPOLATION_MODE_LINEAR = 1U,
            ...
            D2D1_3DTRANSFORM_INTERPOLATION_MODE_CUBIC = 2U,
            ...
            D2D1_3DTRANSFORM_INTERPOLATION_MODE_MULTI_SAMPLE_LINEAR = 3U,
            /// <summary>Uses anisotropic filtering to sample a pattern according to the transformed shape of the bitmap.</summary>
            D2D1_3DTRANSFORM_INTERPOLATION_MODE_ANISOTROPIC = 4U,
            /// <summary></summary>
            D2D1_3DTRANSFORM_INTERPOLATION_MODE_FORCE_DWORD = 4294967295U,
        }
    }
}