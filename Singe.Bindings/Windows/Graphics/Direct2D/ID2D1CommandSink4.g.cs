...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct2D
    {
        ...
        internal unsafe struct ID2D1CommandSink4
        {
            ...
            {
                fixed (ID2D1CommandSink4*pThis = &this)
            ...
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_3/nf-d2d1_3-id2d1commandsink4-setprimitiveblend2#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d2d1_3/nf-d2d1_3-id2d1commandsink4-setprimitiveblend2">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.System.Com.HRESULT>BeginDraw_4;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.System.Com.HRESULT>EndDraw_5;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D1_ANTIALIAS_MODE, win32.System.Com.HRESULT>SetAntialiasMode_6;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, ulong, ulong, win32.System.Com.HRESULT>SetTags_7;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D1_TEXT_ANTIALIAS_MODE, win32.System.Com.HRESULT>SetTextAntialiasMode_8;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.DirectWrite.IDWriteRenderingParams*, win32.System.Com.HRESULT>SetTextRenderingParams_9;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D_MATRIX_3X2_F*, win32.System.Com.HRESULT>SetTransform_10;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D1_PRIMITIVE_BLEND, win32.System.Com.HRESULT>SetPrimitiveBlend_11;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D1_UNIT_MODE, win32.System.Com.HRESULT>SetUnitMode_12;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D1_COLOR_F*, win32.System.Com.HRESULT>Clear_13;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN*, win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_DESCRIPTION*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, win32.System.Com.HRESULT>DrawGlyphRun_14;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.Direct2D.D2D_POINT_2F, win32.Graphics.Direct2D.ID2D1Brush*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.System.Com.HRESULT>DrawLine_15;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.ID2D1Brush*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.System.Com.HRESULT>DrawGeometry_16;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.ID2D1Brush*, float, win32.Graphics.Direct2D.ID2D1StrokeStyle*, win32.System.Com.HRESULT>DrawRectangle_17;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.D2D_RECT_F*, float, win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D_MATRIX_4X4_F*, win32.System.Com.HRESULT>DrawBitmap_18;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1Image*, win32.Graphics.Direct2D.D2D_POINT_2F*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, win32.Graphics.Direct2D.D2D1_COMPOSITE_MODE, win32.System.Com.HRESULT>DrawImage_19;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1GdiMetafile*, win32.Graphics.Direct2D.D2D_POINT_2F*, win32.System.Com.HRESULT>DrawGdiMetafile_20;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1Mesh*, win32.Graphics.Direct2D.ID2D1Brush*, win32.System.Com.HRESULT>FillMesh_21;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>FillOpacityMask_22;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1Geometry*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.ID2D1Brush*, win32.System.Com.HRESULT>FillGeometry_23;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.ID2D1Brush*, win32.System.Com.HRESULT>FillRectangle_24;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D1_ANTIALIAS_MODE, win32.System.Com.HRESULT>PushAxisAlignedClip_25;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D1_LAYER_PARAMETERS1*, win32.Graphics.Direct2D.ID2D1Layer*, win32.System.Com.HRESULT>PushLayer_26;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.System.Com.HRESULT>PopAxisAlignedClip_27;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.System.Com.HRESULT>PopLayer_28;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D1_PRIMITIVE_BLEND, win32.System.Com.HRESULT>SetPrimitiveBlend1_29;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1Ink*, win32.Graphics.Direct2D.ID2D1Brush*, win32.Graphics.Direct2D.ID2D1InkStyle*, win32.System.Com.HRESULT>DrawInk_30;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1GradientMesh*, win32.System.Com.HRESULT>DrawGradientMesh_31;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1GdiMetafile*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.Graphics.Direct2D.D2D_RECT_F*, win32.System.Com.HRESULT>DrawGdiMetafile_32;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.ID2D1SpriteBatch*, uint, uint, win32.Graphics.Direct2D.ID2D1Bitmap*, win32.Graphics.Direct2D.D2D1_BITMAP_INTERPOLATION_MODE, win32.Graphics.Direct2D.D2D1_SPRITE_OPTIONS, win32.System.Com.HRESULT>DrawSpriteBatch_33;
                internal delegate *unmanaged[Stdcall]<ID2D1CommandSink4*, win32.Graphics.Direct2D.D2D1_PRIMITIVE_BLEND, win32.System.Com.HRESULT>SetPrimitiveBlend2_34;
            }
