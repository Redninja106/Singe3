...
namespace Windows.Win32
{
    ...
    {
        /// <summary>Optional flags that control the behavior of ID3D10Asynchronous::GetData.</summary>
        /// <remarks>
        /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d10/ne-d3d10-d3d10_async_getdata_flag">Learn more about this API from docs.microsoft.com</see>.</para>
        /// </remarks>
