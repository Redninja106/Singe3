...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct3D12
    {
        ...
        internal unsafe struct ID3D12Device2
        {
            ...
            /// <para>The address of a <a href = "https://docs.microsoft.com/windows/desktop/api/d3d12/ns-d3d12-d3d12_pipeline_state_stream_desc">D3D12_PIPELINE_STATE_STREAM_DESC</a> structure that describes the pipeline state.</para>
            ...
            /// <para>The globally unique identifier (<b>GUID</b>) for the pipeline state interface (<a href = "https://docs.microsoft.com/windows/desktop/api/d3d12/nn-d3d12-id3d12pipelinestate">ID3D12PipelineState</a>).</para>
            ...
            /// <para>A pointer to a memory block that receives a pointer to the <a href = "https://docs.microsoft.com/windows/desktop/api/d3d12/nn-d3d12-id3d12pipelinestate">ID3D12PipelineState</a> interface for the pipeline state object.</para>
            /// <para>The pipeline state object is an immutable state object. It contains no methods.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//d3d12/nf-d3d12-id3d12device2-createpipelinestate#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            /// <para>Type: <b><a href = "/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b></para>
            /// <para>This method returns <b>E_OUTOFMEMORY</b> if there is insufficient memory to create the pipeline state object. See <a href = "https://docs.microsoft.com/windows/desktop/direct3d12/d3d12-graphics-reference-returnvalues">Direct3D 12 Return Codes</a> for other possible return values.</para>
            /// </returns>
            /// <remarks>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, global::System.Guid*, uint *, void *, win32.System.Com.HRESULT>GetPrivateData_4;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, global::System.Guid*, uint, void *, win32.System.Com.HRESULT>SetPrivateData_5;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, global::System.Guid*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>SetPrivateDataInterface_6;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.System.SystemServices.PCWSTR, win32.System.Com.HRESULT>SetName_7;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint>GetNodeCount_8;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_COMMAND_QUEUE_DESC*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateCommandQueue_9;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_COMMAND_LIST_TYPE, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateCommandAllocator_10;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_GRAPHICS_PIPELINE_STATE_DESC*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateGraphicsPipelineState_11;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_COMPUTE_PIPELINE_STATE_DESC*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateComputePipelineState_12;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, win32.Graphics.Direct3D12.D3D12_COMMAND_LIST_TYPE, win32.Graphics.Direct3D12.ID3D12CommandAllocator*, win32.Graphics.Direct3D12.ID3D12PipelineState*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateCommandList_13;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_FEATURE, void *, uint, win32.System.Com.HRESULT>CheckFeatureSupport_14;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_DESCRIPTOR_HEAP_DESC*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateDescriptorHeap_15;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_DESCRIPTOR_HEAP_TYPE, uint>GetDescriptorHandleIncrementSize_16;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, void *, nuint, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateRootSignature_17;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_CONSTANT_BUFFER_VIEW_DESC*, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, void>CreateConstantBufferView_18;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.ID3D12Resource*, win32.Graphics.Direct3D12.D3D12_SHADER_RESOURCE_VIEW_DESC*, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, void>CreateShaderResourceView_19;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.ID3D12Resource*, win32.Graphics.Direct3D12.ID3D12Resource*, win32.Graphics.Direct3D12.D3D12_UNORDERED_ACCESS_VIEW_DESC*, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, void>CreateUnorderedAccessView_20;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.ID3D12Resource*, win32.Graphics.Direct3D12.D3D12_RENDER_TARGET_VIEW_DESC*, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, void>CreateRenderTargetView_21;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.ID3D12Resource*, win32.Graphics.Direct3D12.D3D12_DEPTH_STENCIL_VIEW_DESC*, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, void>CreateDepthStencilView_22;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_SAMPLER_DESC*, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, void>CreateSampler_23;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE*, uint *, uint, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE*, uint *, win32.Graphics.Direct3D12.D3D12_DESCRIPTOR_HEAP_TYPE, void>CopyDescriptors_24;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, win32.Graphics.Direct3D12.D3D12_DESCRIPTOR_HEAP_TYPE, void>CopyDescriptorsSimple_25;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, uint, win32.Graphics.Direct3D12.D3D12_RESOURCE_DESC*, win32.Graphics.Direct3D12.D3D12_RESOURCE_ALLOCATION_INFO>GetResourceAllocationInfo_26;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, win32.Graphics.Direct3D12.D3D12_HEAP_TYPE, win32.Graphics.Direct3D12.D3D12_HEAP_PROPERTIES>GetCustomHeapProperties_27;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_HEAP_PROPERTIES*, win32.Graphics.Direct3D12.D3D12_HEAP_FLAGS, win32.Graphics.Direct3D12.D3D12_RESOURCE_DESC*, win32.Graphics.Direct3D12.D3D12_RESOURCE_STATES, win32.Graphics.Direct3D12.D3D12_CLEAR_VALUE*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateCommittedResource_28;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_HEAP_DESC*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateHeap_29;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.ID3D12Heap*, ulong, win32.Graphics.Direct3D12.D3D12_RESOURCE_DESC*, win32.Graphics.Direct3D12.D3D12_RESOURCE_STATES, win32.Graphics.Direct3D12.D3D12_CLEAR_VALUE*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreatePlacedResource_30;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_RESOURCE_DESC*, win32.Graphics.Direct3D12.D3D12_RESOURCE_STATES, win32.Graphics.Direct3D12.D3D12_CLEAR_VALUE*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateReservedResource_31;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.ID3D12DeviceChild*, win32.System.SystemServices.SECURITY_ATTRIBUTES*, uint, win32.System.SystemServices.PCWSTR, win32.System.SystemServices.HANDLE*, win32.System.Com.HRESULT>CreateSharedHandle_32;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.System.SystemServices.HANDLE, global::System.Guid*, void **, win32.System.Com.HRESULT>OpenSharedHandle_33;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.System.SystemServices.PCWSTR, uint, win32.System.SystemServices.HANDLE*, win32.System.Com.HRESULT>OpenSharedHandleByName_34;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, win32.Graphics.Direct3D12.ID3D12Pageable**, win32.System.Com.HRESULT>MakeResident_35;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, win32.Graphics.Direct3D12.ID3D12Pageable**, win32.System.Com.HRESULT>Evict_36;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, ulong, win32.Graphics.Direct3D12.D3D12_FENCE_FLAGS, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateFence_37;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.System.Com.HRESULT>GetDeviceRemovedReason_38;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_RESOURCE_DESC*, uint, uint, ulong, win32.Graphics.Direct3D12.D3D12_PLACED_SUBRESOURCE_FOOTPRINT*, uint *, ulong *, ulong *, void>GetCopyableFootprints_39;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_QUERY_HEAP_DESC*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateQueryHeap_40;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.System.SystemServices.BOOL, win32.System.Com.HRESULT>SetStablePowerState_41;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_COMMAND_SIGNATURE_DESC*, win32.Graphics.Direct3D12.ID3D12RootSignature*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreateCommandSignature_42;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.ID3D12Resource*, uint *, win32.Graphics.Direct3D12.D3D12_PACKED_MIP_INFO*, win32.Graphics.Direct3D12.D3D12_TILE_SHAPE*, uint *, uint, win32.Graphics.Direct3D12.D3D12_SUBRESOURCE_TILING*, void>GetResourceTiling_43;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.System.SystemServices.LUID>GetAdapterLuid_44;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, void *, nuint, global::System.Guid*, void **, win32.System.Com.HRESULT>CreatePipelineLibrary_45;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.ID3D12Fence**, ulong *, uint, win32.Graphics.Direct3D12.D3D12_MULTIPLE_FENCE_WAIT_FLAGS, win32.System.SystemServices.HANDLE, win32.System.Com.HRESULT>SetEventOnMultipleFenceCompletion_46;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, uint, win32.Graphics.Direct3D12.ID3D12Pageable**, win32.Graphics.Direct3D12.D3D12_RESIDENCY_PRIORITY*, win32.System.Com.HRESULT>SetResidencyPriority_47;
                internal delegate *unmanaged[Stdcall]<ID3D12Device2*, win32.Graphics.Direct3D12.D3D12_PIPELINE_STATE_STREAM_DESC*, global::System.Guid*, void **, win32.System.Com.HRESULT>CreatePipelineState_48;
            }
