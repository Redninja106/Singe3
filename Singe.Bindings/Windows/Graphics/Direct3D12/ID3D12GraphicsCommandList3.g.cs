...
namespace Windows.Win32
{
    ...
    namespace Graphics.Direct3D12
    {
        ...
        internal unsafe struct ID3D12GraphicsCommandList3
        {
            ...
            /// <para>Type: **[ID3D12ProtectedResourceSession](./nn-d3d12-id3d12protectedresourcesession.md)\***</para>
            /// <para>An optional pointer to an **ID3D12ProtectedResourceSession**. You can obtain an **ID3D12ProtectedResourceSession** by calling [ID3D12Device4::CreateProtectedResourceSession](./nf-d3d12-id3d12device4-createprotectedresourcesession.md).</para>
            ...
            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, global::System.Guid*, uint *, void *, win32.System.Com.HRESULT>GetPrivateData_4;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, global::System.Guid*, uint, void *, win32.System.Com.HRESULT>SetPrivateData_5;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, global::System.Guid*, win32.System.Com.IUnknown*, win32.System.Com.HRESULT>SetPrivateDataInterface_6;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.System.SystemServices.PCWSTR, win32.System.Com.HRESULT>SetName_7;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, global::System.Guid*, void **, win32.System.Com.HRESULT>GetDevice_8;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.D3D12_COMMAND_LIST_TYPE>GetType_9;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.System.Com.HRESULT>Close_10;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12CommandAllocator*, win32.Graphics.Direct3D12.ID3D12PipelineState*, win32.System.Com.HRESULT>Reset_11;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12PipelineState*, void>ClearState_12;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, uint, uint, void>DrawInstanced_13;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, uint, int, uint, void>DrawIndexedInstanced_14;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, uint, void>Dispatch_15;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, ulong, void>CopyBufferRegion_16;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.D3D12_TEXTURE_COPY_LOCATION*, uint, uint, uint, win32.Graphics.Direct3D12.D3D12_TEXTURE_COPY_LOCATION*, win32.Graphics.Direct3D12.D3D12_BOX*, void>CopyTextureRegion_17;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, win32.Graphics.Direct3D12.ID3D12Resource*, void>CopyResource_18;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, win32.Graphics.Direct3D12.D3D12_TILED_RESOURCE_COORDINATE*, win32.Graphics.Direct3D12.D3D12_TILE_REGION_SIZE*, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, win32.Graphics.Direct3D12.D3D12_TILE_COPY_FLAGS, void>CopyTiles_19;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, uint, win32.Graphics.Direct3D12.ID3D12Resource*, uint, win32.Graphics.Dxgi.DXGI_FORMAT, void>ResolveSubresource_20;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D11.D3D_PRIMITIVE_TOPOLOGY, void>IASetPrimitiveTopology_21;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, win32.Graphics.Direct3D12.D3D12_VIEWPORT*, void>RSSetViewports_22;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, win32.UI.DisplayDevices.RECT*, void>RSSetScissorRects_23;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, float *, void>OMSetBlendFactor_24;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, void>OMSetStencilRef_25;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12PipelineState*, void>SetPipelineState_26;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, win32.Graphics.Direct3D12.D3D12_RESOURCE_BARRIER*, void>ResourceBarrier_27;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12GraphicsCommandList*, void>ExecuteBundle_28;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, win32.Graphics.Direct3D12.ID3D12DescriptorHeap**, void>SetDescriptorHeaps_29;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12RootSignature*, void>SetComputeRootSignature_30;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12RootSignature*, void>SetGraphicsRootSignature_31;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, win32.Graphics.Direct3D12.D3D12_GPU_DESCRIPTOR_HANDLE, void>SetComputeRootDescriptorTable_32;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, win32.Graphics.Direct3D12.D3D12_GPU_DESCRIPTOR_HANDLE, void>SetGraphicsRootDescriptorTable_33;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, uint, void>SetComputeRoot32BitConstant_34;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, uint, void>SetGraphicsRoot32BitConstant_35;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, void *, uint, void>SetComputeRoot32BitConstants_36;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, void *, uint, void>SetGraphicsRoot32BitConstants_37;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, ulong, void>SetComputeRootConstantBufferView_38;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, ulong, void>SetGraphicsRootConstantBufferView_39;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, ulong, void>SetComputeRootShaderResourceView_40;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, ulong, void>SetGraphicsRootShaderResourceView_41;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, ulong, void>SetComputeRootUnorderedAccessView_42;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, ulong, void>SetGraphicsRootUnorderedAccessView_43;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.D3D12_INDEX_BUFFER_VIEW*, void>IASetIndexBuffer_44;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, win32.Graphics.Direct3D12.D3D12_VERTEX_BUFFER_VIEW*, void>IASetVertexBuffers_45;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, win32.Graphics.Direct3D12.D3D12_STREAM_OUTPUT_BUFFER_VIEW*, void>SOSetTargets_46;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE*, win32.System.SystemServices.BOOL, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE*, void>OMSetRenderTargets_47;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, win32.Graphics.Direct3D12.D3D12_CLEAR_FLAGS, float, byte, uint, win32.UI.DisplayDevices.RECT*, void>ClearDepthStencilView_48;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, float *, uint, win32.UI.DisplayDevices.RECT*, void>ClearRenderTargetView_49;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.D3D12_GPU_DESCRIPTOR_HANDLE, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, win32.Graphics.Direct3D12.ID3D12Resource*, uint *, uint, win32.UI.DisplayDevices.RECT*, void>ClearUnorderedAccessViewUint_50;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.D3D12_GPU_DESCRIPTOR_HANDLE, win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE, win32.Graphics.Direct3D12.ID3D12Resource*, float *, uint, win32.UI.DisplayDevices.RECT*, void>ClearUnorderedAccessViewFloat_51;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, win32.Graphics.Direct3D12.D3D12_DISCARD_REGION*, void>DiscardResource_52;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12QueryHeap*, win32.Graphics.Direct3D12.D3D12_QUERY_TYPE, uint, void>BeginQuery_53;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12QueryHeap*, win32.Graphics.Direct3D12.D3D12_QUERY_TYPE, uint, void>EndQuery_54;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12QueryHeap*, win32.Graphics.Direct3D12.D3D12_QUERY_TYPE, uint, uint, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, void>ResolveQueryData_55;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, win32.Graphics.Direct3D12.D3D12_PREDICATION_OP, void>SetPredication_56;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, void *, uint, void>SetMarker_57;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, void *, uint, void>BeginEvent_58;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, void>EndEvent_59;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12CommandSignature*, uint, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, void>ExecuteIndirect_60;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, uint, win32.Graphics.Direct3D12.ID3D12Resource**, win32.Graphics.Direct3D12.D3D12_SUBRESOURCE_RANGE_UINT64*, void>AtomicCopyBufferUINT_61;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, win32.Graphics.Direct3D12.ID3D12Resource*, ulong, uint, win32.Graphics.Direct3D12.ID3D12Resource**, win32.Graphics.Direct3D12.D3D12_SUBRESOURCE_RANGE_UINT64*, void>AtomicCopyBufferUINT64_62;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, float, float, void>OMSetDepthBounds_63;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, uint, win32.Graphics.Direct3D12.D3D12_SAMPLE_POSITION*, void>SetSamplePositions_64;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12Resource*, uint, uint, uint, win32.Graphics.Direct3D12.ID3D12Resource*, uint, win32.UI.DisplayDevices.RECT*, win32.Graphics.Dxgi.DXGI_FORMAT, win32.Graphics.Direct3D12.D3D12_RESOLVE_MODE, void>ResolveSubresourceRegion_65;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, void>SetViewInstanceMask_66;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, uint, win32.Graphics.Direct3D12.D3D12_WRITEBUFFERIMMEDIATE_PARAMETER*, win32.Graphics.Direct3D12.D3D12_WRITEBUFFERIMMEDIATE_MODE*, void>WriteBufferImmediate_67;
                internal delegate *unmanaged[Stdcall]<ID3D12GraphicsCommandList3*, win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession*, void>SetProtectedResourceSession_68;
            }
