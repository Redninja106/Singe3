...
namespace Windows.Win32
{
    ...
    namespace Graphics.Imaging
    {
        ...
        internal unsafe struct IWICBitmapScaler
        {
            ...
            {
                fixed (IWICBitmapScaler*pThis = &this)
            ...
            /// </param>
            /// <param name = "mode">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/wincodec/ne-wincodec-wicbitmapinterpolationmode">WICBitmapInterpolationMode</a></b></para>
            /// <para>The <a href = "https://docs.microsoft.com/windows/desktop/api/wincodec/ne-wincodec-wicbitmapinterpolationmode">WICBitmapInterpolationMode</a> to use when scaling.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//wincodec/nf-wincodec-iwicbitmapscaler-initialize#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//wincodec/nf-wincodec-iwicbitmapscaler-initialize">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            internal unsafe win32.System.Com.HRESULT Initialize(win32.Graphics.Imaging.IWICBitmapSource*pISource, uint uiWidth, uint uiHeight, win32.Graphics.Imaging.WICBitmapInterpolationMode mode)
            {
                fixed (IWICBitmapScaler*pThis = &this)
                    return lpVtbl->Initialize_9(pThis, pISource, uiWidth, uiHeight, mode);
            }

            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, uint *, uint *, win32.System.Com.HRESULT>GetSize_4;
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, global::System.Guid*, win32.System.Com.HRESULT>GetPixelFormat_5;
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, double *, double *, win32.System.Com.HRESULT>GetResolution_6;
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, win32.Graphics.Imaging.IWICPalette*, win32.System.Com.HRESULT>CopyPalette_7;
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, win32.Graphics.Imaging.WICRect*, uint, uint, byte *, win32.System.Com.HRESULT>CopyPixels_8;
                internal delegate *unmanaged[Stdcall]<IWICBitmapScaler*, win32.Graphics.Imaging.IWICBitmapSource*, uint, uint, win32.Graphics.Imaging.WICBitmapInterpolationMode, win32.System.Com.HRESULT>Initialize_9;
            }
