...
namespace Windows.Win32
{
    ...
    namespace Graphics.Imaging
    {
        ...
        internal unsafe struct IWICBitmapFlipRotator
        {
            ...
            {
                fixed (IWICBitmapFlipRotator*pThis = &this)
            ...
            /// </param>
            /// <param name = "options">
            /// <para>Type: <b><a href = "https://docs.microsoft.com/windows/desktop/api/wincodec/ne-wincodec-wicbitmaptransformoptions">WICBitmapTransformOptions</a></b></para>
            /// <para>The <a href = "https://docs.microsoft.com/windows/desktop/api/wincodec/ne-wincodec-wicbitmaptransformoptions">WICBitmapTransformOptions</a> to flip or rotate the image.</para>
            /// <para><see href = "https://docs.microsoft.com/windows/win32/api//wincodec/nf-wincodec-iwicbitmapfliprotator-initialize#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            ...
            /// </remarks>
            internal unsafe win32.System.Com.HRESULT Initialize(win32.Graphics.Imaging.IWICBitmapSource*pISource, win32.Graphics.Imaging.WICBitmapTransformOptions options)
            {
                fixed (IWICBitmapFlipRotator*pThis = &this)
                    return lpVtbl->Initialize_9(pThis, pISource, options);
            }

            private struct Vtbl
            {
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, global::System.Guid*, void **, win32.System.Com.HRESULT>QueryInterface_1;
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, uint>AddRef_2;
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, uint>Release_3;
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, uint *, uint *, win32.System.Com.HRESULT>GetSize_4;
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, global::System.Guid*, win32.System.Com.HRESULT>GetPixelFormat_5;
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, double *, double *, win32.System.Com.HRESULT>GetResolution_6;
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, win32.Graphics.Imaging.IWICPalette*, win32.System.Com.HRESULT>CopyPalette_7;
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, win32.Graphics.Imaging.WICRect*, uint, uint, byte *, win32.System.Com.HRESULT>CopyPixels_8;
                internal delegate *unmanaged[Stdcall]<IWICBitmapFlipRotator*, win32.Graphics.Imaging.IWICBitmapSource*, win32.Graphics.Imaging.WICBitmapTransformOptions, win32.System.Com.HRESULT>Initialize_9;
            }
