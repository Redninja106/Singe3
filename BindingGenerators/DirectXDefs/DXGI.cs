// >> this file is not an actual C# file, but instead the definitions used by the bindings generator.
// >> It's marked C# in order to make use of VS's syntax highlighing and region collapsing.

// >> defs from other files, for highlighting
>> interface IUnknown { }
>> struct HRESULT { }
>> struct REFGUID { }
>> struct REFIID { }
